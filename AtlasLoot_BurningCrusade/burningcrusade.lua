...
--- World Bosses
	...
	AtlasLoot_Data["MountHyjalWinterchill"] = {
		{ 1, 0, "INV_Box_01", "=q6=#j1#", ""};
		{ 2, 30871, "", "=q4=Bracers of Martyrdom", "=ds=#s8#, #a1#", "", "17%"};
		{ 3, 30870, "", "=q4=Cuffs of Devastation", "=ds=#s8#, #a1#", "", "16%"};
		{ 4, 30863, "", "=q4=Deadly Cuffs", "=ds=#s8#, #a2#", "", "15%"};
		{ 5, 30868, "", "=q4=Rejuvenating Bracers", "=ds=#s8#, #a2#", "", "16%"};
		{ 6, 30864, "", "=q4=Bracers of the Pathfinder", "=ds=#s8#, #a3#", "", "15%"};
		{ 7, 30869, "", "=q4=Howling Wind Bracers", "=ds=#s8#, #a3#", "", "12%"};
		{ 8, 30873, "", "=q4=Stillwater Boots", "=ds=#s12#, #a3#", "", "14%"};
		{ 9, 30866, "", "=q4=Blood-stained Pauldrons", "=ds=#s3#, #a4#", "", "15%"};
		{ 10, 30862, "", "=q4=Blessed Adamantite Bracers", "=ds=#s8#, #a4#", "", "15%"};
		{ 11, 30861, "", "=q4=Furious Shackles", "=ds=#s8#, #a4#", "", "15%"};
		...
		{ 23, 0, "INV_Box_01", "=q6=#j3#", ""};
		{ 24, 57526, "", "=q4=Tracker's Blade HC", "=ds=#h1#, #w4#", "", "100%"};
		{ 25, 57527, "", "=q4=Chronicle of Dark Secrets HC", "=ds=#s15#", "", "100%"};
		Next = "MountHyjalAnetheron";
	};

	AtlasLoot_Data["MountHyjalAnetheron"] = {
		{ 1, 0, "INV_Box_01", "=q6=#j1#", ""};
		{ 2, 30884, "", "=q4=Hatefury Mantle", "=ds=#s3#, #a1#", "", "16%"};
		{ 3, 30888, "", "=q4=Anetheron's Noose", "=ds=#s10#, #a1#", "", "16%"};
		{ 4, 30885, "", "=q4=Archbishop's Slippers", "=ds=#s12#, #a1#", "", "17%"};
		{ 5, 30879, "", "=q4=Don Alejandro's Money Belt", "=ds=#s10#, #a2#", "", "16%"};
		{ 6, 30886, "", "=q4=Enchanted Leather Sandals", "=ds=#s12#, #a2#", "", "15%"};
		{ 7, 30887, "", "=q4=Golden Links of Restoration", "=ds=#s5#, #a3#", "", "16%"};
		{ 8, 30880, "", "=q4=Quickstrider Moccasins", "=ds=#s12#, #a3#", "", "16%"};
		{ 9, 30878, "", "=q4=Glimmering Steel Mantle", "=ds=#s3#, #a4#", "", "16%"};
		...
		{ 21, 29434, "", "=q4=Badge of Justice", "=ds=#e15#", "", "100%"};
		{ 23, 0, "INV_Box_01", "=q6=#j3#", ""};
		{ 24, 57529, "", "=q4=Pillar of Ferocity HC", "=ds=#w9#", "", "100%"};
		{ 25, 57528, "", "=q4=Bastion of Light HC", "=ds=#w8#", "", "100%"};
	...
	AtlasLoot_Data["MountHyjalKazrogal"] = {
		{ 1, 0, "INV_Box_01", "=q6=#j1#", ""};
		{ 2, 30895, "", "=q4=Angelista's Sash", "=ds=#s10#, #a1#", "", "16%"};
		{ 3, 30916, "", "=q4=Leggings of Channeled Elements", "=ds=#s11#, #a1#", "", "17%"};
		{ 4, 30894, "", "=q4=Blue Suede Shoes", "=ds=#s12#, #a1#", "", "16%"};
		{ 5, 30917, "", "=q4=Razorfury Mantle", "=ds=#s3#, #a2#", "", "17%"};
		{ 6, 30914, "", "=q4=Belt of the Crescent Moon", "=ds=#s10#, #a2#", "", "9%"};
		{ 7, 30891, "", "=q4=Black Featherlight Boots", "=ds=#s12#, #a2#", "", "14%"};
		{ 8, 30892, "", "=q4=Beast-tamer's Shoulders", "=ds=#s3#, #a3#", "", "15%"};
		{ 9, 30919, "", "=q4=Valestalker Girdle", "=ds=#s10#, #a3#", "", "15%"};
		{ 10, 30893, "", "=q4=Sun-touched Chain Leggings", "=ds=#s11#, #a3#", "", "15%"};
		{ 11, 30915, "", "=q4=Belt of Seething Fury", "=ds=#s10#, #a4#", "", "17%"};
		{ 16, 30918, "", "=q4=Hammer of Atonement", "=ds=#h3#, #w6#", "", "17%"};
		{ 17, 30889, "", "=q4=Kaz'rogal's Hardened Heart", "=ds=#w8#", "", "16%"};
		{ 19, 29434, "", "=q4=Badge of Justice", "=ds=#e15#", "", "100%"};
		{ 21, 0, "INV_Box_01", "=q6=#j3#", ""};
		{ 22, 57531, "", "=q4=Hammer of Atonement HC", "=ds=#h3#, #w6#", "", "100%"};
		{ 23, 57530, "", "=q4=Kaz'rogal's Hardened Heart HC", "=ds=#w8#", "", "100%"};
	...
	AtlasLoot_Data["MountHyjalAzgalor"] = {
		{ 1, 0, "INV_Box_01", "=q6=#j1#", ""};
		{ 2, 30899, "", "=q4=Don Rodrigo's Poncho", "=ds=#s5#, #a2#", "", "15%"};
		{ 3, 30898, "", "=q4=Shady Dealer's Pantaloons", "=ds=#s11#, #a2#", "", "16%"};
		{ 4, 30900, "", "=q4=Bow-stitched Leggings", "=ds=#s11#, #a3#", "", "15%"};
		{ 5, 30896, "", "=q4=Glory of the Defender", "=ds=#s5#, #a4#", "", "15%"};
		{ 6, 30897, "", "=q4=Girdle of Hope", "=ds=#s10#, #a4#", "", "15%"};
		{ 7, 30901, "", "=q4=Boundless Agony", "=ds=#h1#, #w4#", "", "16%"};
		...
		{ 20, 29434, "", "=q4=Badge of Justice", "=ds=#e15#", "", "100%"};
		{ 22, 0, "INV_Box_01", "=q6=#j3#", ""};
		{ 23, 31092, "", "=q4=Gloves of the Forgotten Conqueror", "=ds=#m23# #e15#", "", "100%"};
		{ 24, 31094, "", "=q4=Gloves of the Forgotten Protector", "=ds=#m23# #e15#", "", "100%"};
		{ 25, 31093, "", "=q4=Gloves of the Forgotten Vanquisher", "=ds=#m23# #e15#", "", "100%"};
	...
	AtlasLoot_Data["MountHyjalArchimonde"] = {
		{ 1, 0, "INV_Box_01", "=q6=#j1#", ""};
		{ 2, 30913, "", "=q4=Robes of Rhonin", "=ds=#s5#, #a1#", "", "15%"};
		{ 3, 30912, "", "=q4=Leggings of Eternity", "=ds=#s11#, #a1#", "", "15%"};
		{ 4, 30905, "", "=q4=Midnight Chestguard", "=ds=#s5#, #a2#", "", "14%"};
		{ 5, 30907, "", "=q4=Mail of Fevered Pursuit", "=ds=#s5#, #a3#", "", "15%"};
		{ 6, 30904, "", "=q4=Savior's Grasp", "=ds=#s5#, #a4#", "", "14%"};
		{ 7, 30903, "", "=q4=Legguards of Endless Rage", "=ds=#s11#, #a4#", "", "15%"};
		{ 8, 30911, "", "=q4=Scepter of Purification", "=ds=#s15#", "", "15%"};
		{ 10, 30910, "", "=q4=Tempest of Chaos", "=ds=#h3#, #w10#", "", "14%"};
		{ 11, 30902, "", "=q4=Cataclysm's Edge", "=ds=#h2#, #w10#", "", "15%"};
		{ 12, 30908, "", "=q4=Apostle of Argus", "=ds=#w9#", "", "15%"};
		{ 13, 30909, "", "=q4=Antonidas's Aegis of Rapt Concentration", "=ds=#w8#", "", "15%"};
		{ 14, 30906, "", "=q4=Bristleblitz Striker", "=ds=#w2#", "", "16%"};
		...
		{ 20, 29434, "", "=q4=Badge of Justice", "=ds=#e15#", "", "100%"};
		{ 22, 0, "INV_Box_01", "=q6=#j3#", ""};
		{ 23, 57532, "", "=q4=Cataclysm's Edge HC", "=ds=#h2#, #w10#", "", "100%"};
		{ 24, 57533, "", "=q4=Apostle of Argus", "=ds=#w9#", "", "100%"};
		{ 25, 57534, "", "=q4=Bristleblitz Striker", "=ds=#w2#", "", "100%"};
	...
	AtlasLoot_Data["CFRSerpentHydross"] = {
		{ 1, 0, "INV_Box_01", "=q6=#j1#", ""};
		{ 2, 30056, "", "=q4=Robe of Hateful Echoes", "=ds=#s5#, #a1#", "", "18%"};
		{ 3, 32516, "", "=q4=Wraps of Purification", "=ds=#s8#, #a1#", "", "18%"};
		{ 4, 30050, "", "=q4=Boots of the Shifting Nightmare", "=ds=#s12#, #a1#", "", "17%"};
		{ 5, 30055, "", "=q4=Shoulderpads of the Stranger", "=ds=#s3#, #a2#", "", "16%"};
		{ 6, 30047, "", "=q4=Blackfathom Warbands", "=ds=#s8#, #a3#", "", "19%"};
		{ 7, 30054, "", "=q4=Ranger-General's Chestguard", "=ds=#s5#, #a3#", "", "18%"};
		{ 8, 30048, "", "=q4=Brighthelm of Justice", "=ds=#s1#, #a4#", "", "21%"};
		{ 9, 30053, "", "=q4=Pauldrons of the Wardancer", "=ds=#s3#, #a4#", "", "16%"};
		...
		{ 25, 0, "INV_Box_01", "=q6=#j3#", ""};
		{ 26, 57467, "", "=q4=Scarab of Displacement HC", "=ds=#s14#", "", "100%"};
		{ 27, 57468, "", "=q4=Fathomstone HC", "=ds=#s15#", "", "100%"};
		Next = "CFRSerpentLurker";
	};

	AtlasLoot_Data["CFRSerpentLurker"] = {
		{ 1, 0, "INV_Box_01", "=q6=#j1#", ""};
		{ 2, 30064, "", "=q4=Cord of Screaming Terrors", "=ds=#s10#, #a1#", "", "17%"};
		{ 3, 30067, "", "=q4=Velvet Boots of the Guardian", "=ds=#s12#, #a1#", "", "17%"};
		{ 4, 30062, "", "=q4=Grove-Bands of Remulos", "=ds=#s8#, #a2#", "", "21%"};
		{ 5, 30060, "", "=q4=Boots of Effortless Striking", "=ds=#s12#, #a2#", "", "21%"};
		{ 6, 30066, "", "=q4=Tempest-Strider Boots", "=ds=#s12#, #a3#", "", "21%"};
		{ 7, 30065, "", "=q4=Glowing Breastplate of Truth", "=ds=#s5#, #a4#", "", "20%"};
		{ 8, 30057, "", "=q4=Bracers of Eradication", "=ds=#s8#, #a4#", "", "19%"};
		{ 9, 29434, "", "=q4=Badge of Justice", "=ds=#e15#", "", "100%"};
		...
		{ 23, 0, "INV_Box_01", "=q6=#j3#", ""};
		{ 24, 57469, "", "=q4=Earring of Soulful Meditation HC", "=ds=#s14#, =q1=#m1# =ds=#c5#", "", "100%"};
		{ 25, 57470, "", "=q4=Mallet of the Tides HC", "=ds=#h1#, #w6#", "", "100%"};
	...
	AtlasLoot_Data["CFRSerpentLeotheras"] = {
		{ 1, 0, "INV_Box_01", "=q6=#j1#", ""};
		{ 2, 30092, "", "=q4=Orca-Hide Boots", "=ds=#s12#, #a2#", "", "13%"};
		{ 3, 30097, "", "=q4=Coral-Barbed Shoulderpads", "=ds=#s3#, #a3#", "", "15%"};
		{ 4, 30091, "", "=q4=True-Aim Stalker Bands", "=ds=#s8#, #a3#", "", "17%"};
		{ 5, 30096, "", "=q4=Girdle of the Invulnerable", "=ds=#s10#, #a4#", "", "14%"};
		{ 6, 30627, "", "=q4=Tsunami Talisman", "=ds=#s14#", "", "15%"};
		{ 7, 30095, "", "=q4=Fang of the Leviathan", "=ds=#h3#, #w10#", "", "14%"};
		...
		{ 20, 29434, "", "=q4=Badge of Justice", "=ds=#e15#", "", "100%"};
		{ 22, 0, "INV_Box_01", "=q6=#j3#", ""};
		{ 23, 57471, "", "=q4=Tsunami Talisman HC", "=ds=#s14#", "", "100%"};
		{ 24, 57472, "", "=q4=Fang of the Leviathan HC", "=ds=#h3#, #w10#", "", "100%"};
	...
	AtlasLoot_Data["CFRSerpentKarathress"] = {
		{ 1, 0, "INV_Box_01", "=q6=#j1#", ""};
		{ 2, 30100, "", "=q4=Soul-Strider Boots", "=ds=#s12#, #a1#", "", "15%"};
		{ 3, 30101, "", "=q4=Bloodsea Brigand's Vest", "=ds=#s5#, #a2#", "", "15%"};
		{ 4, 30099, "", "=q4=Frayed Tether of the Drowned", "=ds=#s2#", "", "15%"};
		{ 5, 30663, "", "=q4=Fathom-Brooch of the Tidewalker", "=ds=#s14#, =q1=#m1# =ds=#c7#", "", "15%"};
		{ 6, 30626, "", "=q4=Sextant of Unstable Currents", "=ds=#s14#", "", "14%"};
		{ 7, 30090, "", "=q4=World Breaker", "=ds=#h2#, #w6#", "", "15%"};
		...
		{ 20, 29434, "", "=q4=Badge of Justice", "=ds=#e15#", "", "100%"};
		{ 22, 0, "INV_Box_01", "=q6=#j3#", ""};
		{ 23, 57474, "", "=q4=Sextant of Unstable Currents HC", "=ds=#s14#", "", "100%"};
		{ 24, 57473, "", "=q4=World Breaker HC", "=ds=#h2#, #w6#", "", "100%"};
	...
	AtlasLoot_Data["CFRSerpentMorogrim"] = {
		{ 1, 0, "INV_Box_01", "=q6=#j1#", ""};
		{ 2, 30098, "", "=q4=Razor-Scale Battlecloak", "=ds=#s4#", "", "22%"};
		{ 3, 30079, "", "=q4=Illidari Shoulderpads", "=ds=#s3#, #a1#", "", "15%"};
		{ 4, 30075, "", "=q4=Gnarled Chestpiece of the Ancients", "=ds=#s5#, #a2#", "", "19%"};
		{ 5, 30085, "", "=q4=Mantle of the Tireless Tracker", "=ds=#s3#, #a3#", "", "20%"};
		{ 6, 30068, "", "=q4=Girdle of the Tidal Call", "=ds=#s10#, #a3#", "", "17%"};
		{ 7, 30084, "", "=q4=Pauldrons of the Argent Sentinel", "=ds=#s3#, #a4#", "", "21%"};
		{ 8, 30081, "", "=q4=Warboots of Obliteration", "=ds=#s12#, #a4#", "", "21%"};
		...
		{ 23, 0, "INV_Box_01", "=q6=#j3#", ""};
		{ 24, 57476, "", "=q4=Pendant of the Lost Ages", "=ds=#s2#", "", "100%"};
		{ 25, 57475, "", "=q4=Luminescent Rod of the Naaru HC", "=ds=#w12#", "", "100%"};
	...
	AtlasLoot_Data["CFRSerpentVashj"] = {
		{ 1, 0, "INV_Box_01", "=q6=#j1#", ""};
		{ 2, 30107, "", "=q4=Vestments of the Sea-Witch", "=ds=#s5#, #a1#", "", "13%"};
		{ 3, 30111, "", "=q4=Runetotem's Mantle", "=ds=#s3#, #a2#", "", "14%"};
		{ 4, 30106, "", "=q4=Belt of One-Hundred Deaths", "=ds=#s10#, #a2#", "", "12%"};
		{ 5, 30104, "", "=q4=Cobra-Lash Boots", "=ds=#s12#, #a3#", "", "13%"};
		{ 6, 30102, "", "=q4=Krakken-Heart Breastplate", "=ds=#s5#, #a4#", "", "15%"};
		{ 7, 30112, "", "=q4=Glorious Gauntlets of Crestfall", "=ds=#s9#, #a4#", "", "14%"};
		{ 8, 30109, "", "=q4=Ring of Endless Coils", "=ds=#s13#", "", "13%"};
		{ 9, 30110, "", "=q4=Coral Band of the Revived", "=ds=#s13#", "", "16%"};
		{ 10, 30621, "", "=q4=Prism of Inner Calm", "=ds=#s14#", "", "13%"};
		{ 11, 30103, "", "=q4=Fang of Vashj", "=ds=#h1#, #w4#", "", "14%"};
		{ 12, 30108, "", "=q4=Lightfathom Scepter", "=ds=#h3#, #w6#", "", "14%"};
		{ 13, 30105, "", "=q4=Serpent Spine Longbow", "=ds=#w2#", "", "13%"};
		...
		{ 24, 0, "INV_Box_01", "=q6=#j3#", ""};
		{ 25, 57479, "", "=q4=Prism of Inner Calm HC", "=ds=#s14#", "", "100%"};
		{ 26, 57478, "", "=q4=Fang of Vashj HC", "=ds=#h1#, #w4#", "", "100%"};
		{ 27, 57477, "", "=q4=Serpent Spine Longbow HC", "=ds=#w2#", "", "100%"};
	...
	AtlasLoot_Data["GruulsLairHighKingMaulgar"] = {
		{ 1, 0, "INV_Box_01", "=q6=#j1#", ""};
		{ 2, 28797, "", "=q4=Brute Cloak of the Ogre-Magi", "#s4#", "", "8.39%"};
		{ 3, 28799, "", "=q4=Belt of Divine Inspiration", "#s10#, #a1#", "", "9.98%"};
		{ 4, 28796, "", "=q4=Malefic Mask of the Shadows", "=ds=#s1#, #a2#", "", "12.93%"};
		{ 5, 28801, "", "=q4=Maulgar's Warhelm", "=ds=#s1#, #a3#", "", "21.32%"};
		{ 6, 28795, "", "=q4=Bladespire Warbands", "=ds=#s8#, #a4#", "", "12.02%"};
		{ 7, 28800, "", "=q4=Hammer of the Naaru", "=ds=#h2#, #w6#", "", "15.87%"};
		{ 9, 29763, "", "=q4=Pauldrons of the Fallen Champion", "=ds=#m21# #e15#", "", "22.68%"};
		{ 10, 29764, "", "=q4=Pauldrons of the Fallen Defender", "=ds=#m21# #e15#", "", "34.69%"};
		{ 11, 29762, "", "=q4=Pauldrons of the Fallen Hero", "=ds=#m21# #e15#", "", "25.62%"};
		{ 13, 29434, "", "=q4=Badge of Justice", "=ds=#e15#", "", "100%"};
		{ 16, 0, "INV_Box_01", "Roltall (Custom) 5", ""};
		{ 17, 29763, "", "=q4=Pauldrons of the Fallen Champion", "=ds=#m21# #e15#", "", "22.68%"};
		{ 18, 29764, "", "=q4=Pauldrons of the Fallen Defender", "=ds=#m21# #e15#", "", "34.69%"};
		{ 19, 29762, "", "=q4=Pauldrons of the Fallen Hero", "=ds=#m21# #e15#", "", "25.62%"};
		{ 22, 0, "INV_Box_01", "=q6=#j3#", ""};
		{ 23, 57450, "", "=q4=Brooch of the Brood", "=ds=#s14#", "", "100%"};
		{ 24, 57451, "", "=q4=Bloodmaw Magus-Blade HC", "=ds=#h3#, #w10#", "", "100%"};
		Next = "GruulGruul";
	};

	AtlasLoot_Data["GruulGruul"] = {
		{ 1, 0, "INV_Box_01", "=q6=#j1#", ""};
		{ 2, 28804, "", "=q4=Collar of Cho'gall", "=ds=#s1#, #a1#", "", "14.96%"};
		{ 3, 28803, "", "=q4=Cowl of Nature's Breath", "=ds=#s1#, #a2#", "", "14.21%"};
		{ 4, 28828, "", "=q4=Gronn-Stitched Girdle", "=ds=#s10#, #a2#", "", "11.22%"};
		{ 5, 28827, "", "=q4=Gauntlets of the Dragonslayer", "=ds=#s9#, #a3#", "", "7.48%"};
		{ 6, 28810, "", "=q4=Windshear Boots", "=ds=#s12#, #a3#", "", "10.22%"};
		{ 7, 28824, "", "=q4=Gauntlets of Martial Perfection", "=ds=#s9#, #a4#", "", "12.22%"};
		{ 8, 28822, "", "=q4=Teeth of Gruul", "=ds=#s2#", "", "11.47%"};
		{ 9, 28823, "", "=q4=Eye of Gruul", "=ds=#s14#", "", "6.73%"};
		{ 10, 28830, "", "=q4=Dragonspine Trophy", "=ds=#s14#", "", "11.72%"};
		{ 12, 31750, "", "=q1=Earthen Signet", "=ds=#m3#", "", "100%"};
		...
		{ 27, 0, "INV_Box_01", "=q6=#j3#", ""};
		{ 28, 57453, "", "=q4=Dragonspine Trophy HC", "=ds=#s14#", "", "100%"};
		{ 29, 57452, "", "=q4=Aldori Legacy Defender HC", "=ds=#w8#", "", "100%"};
	...
	AtlasLoot_Data["HCMag"] = {
		{ 1, 0, "INV_Box_01", "Belac (Custom)", ""};
		{ 3, 34845, "", "=q4=Pit Lord's Satchel", "=ds=#e1# #m15#"};
		{ 5, 0, "INV_Box_01", " HC (Custom)", ""};
		{ 6, 57446, "", "=q4=Eye of Magtheridon HC", "=ds=#s14#"};
		{ 7, 57445, "", "=q4=Glaive of the Pit HC", "=ds=#w7#"};
		{ 16, 0, "INV_Box_01", "Magtheridon HC", ""};
		{ 17, 57447, "", "=q4=Eredar Wand of Obliteration", "=ds=#w12#"};
		{ 18, 57449, "", "=q4=Ring of the Recalcitrant HC", "=ds=#s13#"};
		{ 20, 57448, "", "=q4=Pit Lord's Satchel HC", "=ds=#e1# #m15#"};
		Prev = "HCMagtheridon"
	};
	...
	AtlasLoot_Data["KaraAttumen"] = {
		{ 1, 0, "INV_Box_01", "=q6=#j1#", ""};
		{ 2, 28477, "", "=q4=Harbinger Bands", "=ds=#s8#, #a1#", "", "14.68%"};
		{ 3, 28507, "", "=q4=Handwraps of Flowing Thought", "=ds=#s9#, #a1#", "", "12.44%"};
		{ 4, 28508, "", "=q4=Gloves of Saintly Blessings", "=ds=#s9#, #a1#", "", "11.69%"};
		{ 5, 28453, "", "=q4=Bracers of the White Stag", "=ds=#s8#, #a2#", "", "12.19%"};
		{ 6, 28506, "", "=q4=Gloves of Dexterous Manipulation", "=ds=#s9#, #a2#", "", "14.68%"};
		{ 7, 28503, "", "=q4=Whirlwind Bracers", "=ds=#s8#, #a3#", "", "9.20%"};
		{ 8, 28454, "", "=q4=Stalker's War Bands", "=ds=#s8#, #a3#", "", "16.17%"};
		{ 9, 28502, "", "=q4=Vambraces of Courage", "=ds=#s8#, #a4#", "", "10.70%"};
		{ 10, 28505, "", "=q4=Gauntlets of Renewed Hope", "=ds=#s9#, #a4#", "", "10.95%"};
		...
		{ 25, 0, "INV_Box_01", "=q6=#j3#", ""};
		{ 26, 57425, "", "=q4=Worgen Claw Necklace HC", "=ds=#s2#", "", "100%"};
		{ 27, 57426, "", "=q4=Steelhawk Crossbow HC", "=ds=#w3#", "", "100%"};
		Next = "KaraMoroes";
	};

	AtlasLoot_Data["KaraMoroes"] = {
		{ 1, 0, "INV_Box_01", "=q6=#j1#", ""};
		{ 2, 28529, "", "=q4=Royal Cloak of Arathi Kings", "=ds=#s4#", "", "15.91%"};
		{ 3, 28570, "", "=q4=Shadow-Cloak of Dalaran", "=ds=#s4#", "", "12.18%"};
		{ 4, 28565, "", "=q4=Nethershard Girdle", "=ds=#s10#, #a1#", "", "14.08%"};
		{ 5, 28545, "", "=q4=Edgewalker Longboots", "=ds=#s12#, #a2#", "", "11.07%"};
		{ 6, 28567, "", "=q4=Belt of Gale Force", "=ds=#s10#, #a3#", "", "12.05%"};
		{ 7, 28566, "", "=q4=Crimson Girdle of the Indomitable", "=ds=#s10#, #a4#", "", "10.81%"};
		{ 8, 28569, "", "=q4=Boots of Valiance", "=ds=#s12#, #a4#", "", "11.33%"};
		{ 10, 29434, "", "=q4=Badge of Justice", "=ds=#e15#", "", "100%"};
		...
		{ 24, 0, "INV_Box_01", "=q6=#j3#", ""};
		{ 25, 57427, "", "=q4=Moroes' Lucky Pocket Watch HC", "=ds=#s14#", "", "100%"};
		{ 26, 57428, "", "=q4=Signet of Unshakable Faith HC", "=ds=#s15#", "", "100%"};
		Prev = "KaraAttumen";
		Next = "KaraMaiden";
	};
	...
	AtlasLoot_Data["KaraMaiden"] = {
		{ 1, 0, "INV_Box_01", "=q6=#j1#", ""};
		{ 2, 28511, "", "=q4=Bands of Indwelling", "=ds=#s8#, #a1#", "", "12.46%"};
		{ 3, 28515, "", "=q4=Bands of Nefarious Deeds", "=ds=#s8#, #a1#", "", "13.87%"};
		{ 4, 28517, "", "=q4=Boots of Foretelling", "=ds=#s12#, #a1#", "", "16.96%"};
		{ 5, 28514, "", "=q4=Bracers of Maliciousness", "=ds=#s8#, #a2#", "", "15.90%"};
		{ 6, 28521, "", "=q4=Mitts of the Treemender", "=ds=#s9#, #a2#", "", "13.16%"};
		{ 7, 28520, "", "=q4=Gloves of Centering", "=ds=#s9#, #a3#", "", "13.16%"};
		{ 8, 28519, "", "=q4=Gloves of Quickening", "=ds=#s9#, #a3#", "", "14.22%"};
		{ 9, 28512, "", "=q4=Bracers of Justice", "=ds=#s8#, #a4#", "", "15%"};
		{ 10, 28518, "", "=q4=Iron Gauntlets of the Maiden", "=ds=#s9#, #a4#", "", "12.63%"};
		...
		{ 20, 29434, "", "=q4=Badge of Justice", "=ds=#e15#", "", "100%"};
		{ 22, 0, "INV_Box_01", "=q6=#j3#", ""};
		{ 23, 57429, "", "=q4=Barbed Choker of Discipline HC", "=ds=#s2#", "", "100%"};
		{ 24, 57430, "", "=q4=Shard of the Virtuous HC", "=ds=#h3#, #w6#", "", "100%"};
		Prev = "KaraMoroes";
		Next = "KaraOperaEvent";
	};
	...
	AtlasLoot_Data["KaraOperaEvent"] = {
		...
		{ 22, 0, "INV_Box_01", "=q6="..BabbleBoss["The Big Bad Wolf"], "=q5="..AL["Red Riding Hood"]};
		{ 23, 28582, "", "=q4=Red Riding Hood's Cloak", "=ds=#s4#", "", "12.85%"};
		{ 24, 28583, "", "=q4=Big Bad Wolf's Head", "=ds=#s1#, #a3#", "", "16.37%"};
		{ 25, 28584, "", "=q4=Big Bad Wolf's Paw", "=ds=#h3#, #w13#", "", "16.12%"};
		{ 26, 28581, "", "=q4=Wolfslayer Sniper Rifle", "=ds=#w5#", "", "22.42%"};
		{ 28, 0, "INV_Box_01", "=q6=#j3#", ""};
		{ 29, 57432, "", "=q4=Legacy HC", "=ds=#h2#, #w1#", "", "100%"};
		{ 30, 57431, "", "=q4=Romulo's Poison Vial HC", "=ds=#s14#", "", "100%"};
		Prev = "KaraMaiden";
		Next = "KaraCurator";
	};
	...
	AtlasLoot_Data["KaraCurator"] = {
		{ 1, 0, "INV_Box_01", "=q6=#j1#", ""};
		{ 2, 28612, "", "=q4=Pauldrons of the Solace-Giver", "=ds=#s3#, #a1#", "", "15.19%"};
		{ 3, 28647, "", "=q4=Forest Wind Shoulderpads", "=ds=#s3#, #a2#", "", "10.56%"};
		{ 4, 28631, "", "=q4=Dragon-Quake Shoulderguards", "=ds=#s3#, #a3#", "", "13.47%"};
		{ 5, 28621, "", "=q4=Wrynn Dynasty Greaves", "=ds=#s11#, #a4#", "", "11.85%"};
		{ 6, 28649, "", "=q4=Garona's Signet Ring", "=ds=#s13#", "", "12.07%"};
		{ 7, 28633, "", "=q4=Staff of Infinite Mysteries", "=ds=#w9#", "", "12.28%"};
		{ 9, 29434, "", "=q4=Badge of Justice", "=ds=#e15#", "", "100%"};
		...
		{ 20, 0, "INV_Box_01", "=q6=#j3#", ""};
		{ 21, 57433, "", "=q4=Garona's Signet Ring HC", "=ds=#s13#", "", "100%"};
		{ 22, 57434, "", "=q4=Staff of Infinite Mysteries HC", "=ds=#w9#", "", "100%"};
		Prev = "KaraOperaEvent";
		Next = "KaraIllhoof";
	};
	...
	AtlasLoot_Data["KaraIllhoof"] = {
		{ 1, 0, "INV_Box_01", "=q6=#j1#", ""};
		{ 2, 28660, "", "=q4=Gilded Thorium Cloak", "=ds=#s4#", "", "14.63%"};
		{ 3, 28653, "", "=q4=Shadowvine Cloak of Infusion", "=ds=#s4#", "", "10.45%"};
		{ 4, 28652, "", "=q4=Cincture of Will", "=ds=#s10#, #a1#", "", "10.75%"};
		{ 5, 28654, "", "=q4=Malefic Girdle", "=ds=#s10#, #a1#", "", "11.04%"};
		{ 6, 28655, "", "=q4=Cord of Nature's Sustenance", "=ds=#s10#, #a2#", "", "14.93%"};
		{ 7, 28656, "", "=q4=Girdle of the Prowler", "=ds=#s10#, #a3#", "", "17.91%"};
		{ 8, 28662, "", "=q4=Breastplate of the Lightbinder", "=ds=#s5#, #a4#", "", "17.31%"};
		{ 10, 29434, "", "=q4=Badge of Justice", "=ds=#e15#", "", "100%"};
		...
		{ 24, 0, "INV_Box_01", "=q6=#j3#", ""};
		{ 25, 57435, "", "=q4=Fool's Bane HC", "=ds=#h1#, #w6#", "", "100%"};
		{ 26, 57436, "", "=q4=Terestian's Stranglestaff HC", "=ds=#w9#", "", "100%"};
		Prev = "KaraCurator";
		Next = "KaraAran";
	};
	...
	AtlasLoot_Data["KaraAran"] = {
		{ 1, 0, "INV_Box_01", "=q6=#j1#", ""};
		{ 2, 28672, "", "=q4=Drape of the Dark Reavers", "=ds=#s4#", "", "11.70%"};
		{ 3, 28726, "", "=q4=Mantle of the Mind Flayer", "=ds=#s3#, #a1#", "", "16.03%"};
		{ 4, 28670, "", "=q4=Boots of the Infernal Coven", "=ds=#s12#, #a1#", "", "9.29%"};
		{ 5, 28663, "", "=q4=Boots of the Incorrupt", "=ds=#s12#, #a1#", "", "12.72%"};
		{ 6, 28669, "", "=q4=Rapscallion Boots", "=ds=#s12#, #a2#", "", "11.32%"};
		{ 7, 28671, "", "=q4=Steelspine Faceguard", "=ds=#s1#, #a3#", "", "12.21%"};
		{ 8, 28666, "", "=q4=Pauldrons of the Justice-Seeker", "=ds=#s3#, #a4#", "", "11.58%"};
		{ 10, 29434, "", "=q4=Badge of Justice", "=ds=#e15#", "", "100%"};
		{ 12, 23933, "", "=q1=Medivh's Journal", "=ds=#m3#", "", "100%"};
		...
		{ 24, 0, "INV_Box_01", "=q6=#j3#", ""};
		{ 25, 57438, "", "=q4=Shermanar Great-Ring HC", "=ds=#s13#", "", "100%"};
		{ 26, 57437, "", "=q4=Pendant of the Violet Eye HC", "=ds=#s14#", "", "100%"};
		Prev = "KaraIllhoof";
	...
	AtlasLoot_Data["KaraNetherspite"] = {
		{ 1, 0, "INV_Box_01", "=q6=#j1#", ""};
		{ 2, 28744, "", "=q4=Uni-Mind Headdress", "=ds=#s1#, #a1#", "", "12.91%"};
		{ 3, 28742, "", "=q4=Pantaloons of Repentence", "=ds=#s11#, #a1#", "", "10.99%"};
		{ 4, 28732, "", "=q4=Cowl of Defiance", "=ds=#s1#, #a2#", "", "17.31%"};
		{ 5, 28741, "", "=q4=Skulker's Greaves", "=ds=#s11#, #a2#", "", "15.38%"};
		{ 6, 28735, "", "=q4=Earthblood Chestguard", "=ds=#s5#, #a3#", "", "15.93%"};
		{ 7, 28740, "", "=q4=Rip-Flayer Leggings", "=ds=#s11#, #a3#", "", "10.16%"};
		{ 8, 28743, "", "=q4=Mantle of Abrahmis", "=ds=#s3#, #a4#", "", "9.34%"};
		{ 9, 28733, "", "=q4=Girdle of Truth", "=ds=#s10#, #a4#", "", "10.44%"};
		...
		{ 21, 29434, "", "=q4=Badge of Justice", "=ds=#e15#", "", "100%"};
		{ 23, 0, "INV_Box_01", "=q6=#j3#", ""};
		{ 24, 57440, "", "=q4=Shining Chain of the Afterworld HC", "=ds=#s2#", "", "100%"};
		{ 25, 57439, "", "=q4=Spiteblade HC", "=ds=#h1#, #w10#", "", "100%"};
		Prev = "KaraAran";
		Next = "KaraChess";
	};
	...
	AtlasLoot_Data["KaraChess"] = {
		{ 1, 0, "INV_Box_01", "=q6=#j1#", ""};
		{ 2, 28756, "", "=q4=Headdress of the High Potentate", "=ds=#s1#, #a1#", "", "17.98%"};
		{ 3, 28755, "", "=q4=Bladed Shoulderpads of the Merciless", "=ds=#s3#, #a2#", "", "13.55%"};
		{ 4, 28750, "", "=q4=Girdle of Treachery", "=ds=#s10#, #a2#", "", "15.02%"};
		{ 5, 28752, "", "=q4=Forestlord Striders", "=ds=#s12#, #a2#", "", "14.04%"};
		{ 6, 28751, "", "=q4=Heart-Flame Leggings", "=ds=#s11#, #a3#", "", "12.56%"};
		{ 7, 28746, "", "=q4=Fiend Slayer Boots", "=ds=#s12#, #a3#", "", "16.26%"};
		{ 8, 28748, "", "=q4=Legplates of the Innocent", "=ds=#s11#, #a4#", "", "13.79%"};
		{ 9, 28747, "", "=q4=Battlescar Boots", "=ds=#s12#, #a4#", "", "13.79%"};
		...
		{ 21, 29434, "", "=q4=Badge of Justice", "=ds=#e15#", "", "100%"};
		{ 23, 0, "INV_Box_01", "=q6=#j3#", ""};
		{ 24, 57441, "", "=q4=Mithril Chain of Heroism HC", "=ds=#s2#", "", "100%"};
		{ 25, 57442, "", "=q4=Triptych Shield of the Ancients HC", "=ds=#w8#", "", "100%"};
	...
	AtlasLoot_Data["KaraPrince"] = {
		{ 1, 0, "INV_Box_01", "=q6=#j1#", ""};
		{ 2, 28765, "", "=q4=Stainless Cloak of the Pure Hearted", "=ds=#s4#", "", "10.37%"};
		{ 3, 28766, "", "=q4=Ruby Drape of the Mysticant", "=ds=#s4#", "", "12.50%"};
		{ 4, 28764, "", "=q4=Farstrider Wildercloak", "=ds=#s4#", "", "15.96%"};
		{ 5, 28762, "", "=q4=Adornment of Stolen Souls", "=ds=#s2#", "", "9.57%"};
		{ 6, 28763, "", "=q4=Jade Ring of the Everliving", "=ds=#s13#", "", "11.84%"};
		{ 7, 28757, "", "=q4=Ring of a Thousand Marks", "=ds=#s13#", "", "12.90%"};
		{ 9, 28770, "", "=q4=Nathrezim Mindblade", "=ds=#h3#, #w4#", "", "10.64%"};
		{ 10, 28768, "", "=q4=Malchazeen", "=ds=#h1#, #w4#", "", "9.84%"};
		{ 11, 28767, "", "=q4=The Decapitator", "=ds=#h1#, #w1#", "", "15.43%"};
		{ 12, 28773, "", "=q4=Gorehowl", "=ds=#h2#, #w1#", "", "12.63%"};
		{ 13, 28771, "", "=q4=Light's Justice", "=ds=#h3#, #w6#", "", "11.17%"};
		{ 14, 28772, "", "=q4=Sunfury Bow of the Phoenix", "=ds=#w2#", "", "9.97%"};
		...
		{ 20, 29434, "", "=q4=Badge of Justice", "=ds=#e15#", "", "100%"};
		{ 22, 0, "INV_Box_01", "=q6=#j3#", ""};
		{ 23, 57443, "", "=q4=Malchazeen HC", "=ds=#h1#, #w4#", "", "100%"};
		{ 24, 57444, "", "=q4=Gorehowl HC", "=ds=#h2#, #w1#", "", "100%"};
		Prev = "KaraNightbane";
		Next = "KaraTrash";
	};
