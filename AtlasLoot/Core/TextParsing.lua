...
function AtlasLoot_FixText(text)
	...
	text = gsub(text, "#j55#", AL["Mythic Season 1"]);
	text = gsub(text, "#j56#", AL["Mythic Season 2"]);
	text = gsub(text, "#j57#", AL["Mythic Season 3"]);
	...
	text = gsub(text, "#ksc#", "|TInterface\\Icons\\inv_misc_rune_11:0|t");
