...
--------------------
  ...
  -- The Black Temple
	...
	AtlasLoot_TableNames["BTHeroic"] = { BabbleBoss["BTHeroic"], "AtlasLootBurningCrusade" };
  ...
  -- CFR: Serpentshrine Cavern
	...
	AtlasLoot_TableNames["CFRSerpentHC"] = { BabbleBoss["Lady Vashj"], "AtlasLootBurningCrusade" };
  ...
  -- CoT: Hyjal Summit
	...
	AtlasLoot_TableNames["MountHyjalHeroicBoss"]= { BabbleBoss["MountHyjalHeroicBoss"], "AtlasLootBurningCrusade" };
  -- Gruul's Lair
	...
	AtlasLoot_TableNames["GruulHC"] = { BabbleBoss["GruulHC"], "AtlasLootBurningCrusade" };
  -- HC: Blood Furnace
  ...
  -- HC: Magtheridon's Lair
	...
	AtlasLoot_TableNames["HCMag"] = { BabbleBoss["HCMag"], "AtlasLootBurningCrusade" };
  -- HC: Ramparts
  ...
  -- Karazhan
	...
	AtlasLoot_TableNames["KaraHC"] = { BabbleBoss["Prince Malchezaar"], "AtlasLootBurningCrusade" };
...
--	AtlasLoot_TableNames["AzsharaCrater1"] = { BabbleBoss["AzsharaCrater"], "AtlasLootBurningCrusade" };
--	AtlasLoot_TableNames["AzsharaCrater2"] = { BabbleBoss["AzsharaCrater"], "AtlasLootBurningCrusade" };
...
-------------------------
  ...
  -- AzsharaCrater
    AtlasLoot_TableNames["ArchdruidMalodar"] = { BabbleBoss["Archdruid Malodar"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["CaptainMoonstrike"] = { BabbleBoss["Captain Moonstrike"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["Melandrus"] = { BabbleBoss["Melandrus"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["TwilightLordEverun"] = { BabbleBoss["Twilight Lord Everun"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["Trythendra"] = { BabbleBoss["Trythendra"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["ElderSookh"] = { BabbleBoss["Elder Sookh"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["WrathofAzshara"] = { BabbleBoss["Wrath of Azshara"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["ACTrash"] = { "Trash Mobs (Azshara Crater)", "AtlasLootOriginalWoW" };
  -- Blackfathom Deeps
  ...
  -- Blackfathom Deeps Mythic
	AtlasLoot_TableNames["BlackfathomDeeps1MYTHIC"] = { BabbleZone["Blackfathom Deeps"], "AtlasLootOriginalWoW" };
  -- Blackrock Mountain
  ...
  -- Blackwing Lair
	...
	AtlasLoot_TableNames["BWLGonyx"] = { "Dalliah and Gonyx the Watcher", "AtlasLootOriginalWoW" };
  ...
  -- Molten Core HEROIC
	AtlasLoot_TableNames["MCRhannoxHEROIC"] = { "Lord Rhannox", "AtlasLootOriginalWoW" };
  ...
  -- Onyxia's Lair L60
	AtlasLoot_TableNames["OnyxiaL60"] = { BabbleBoss["Onyxia"], "AtlasLootOriginalWoW" };
  -- Onyxia's Lair L60 Heroic
	AtlasLoot_TableNames["OnyxiaL60HEROIC"] = { BabbleBoss["Onyxia"], "AtlasLootOriginalWoW" };
  -- Ragefire Chasm
	AtlasLoot_TableNames["RagefireChasm"] = { BabbleZone["Ragefire Chasm"], "AtlasLootOriginalWoW" };
  -- Ragefire Chasm Mythic
	AtlasLoot_TableNames["RagefireChasmMYTHIC"] = { BabbleZone["Ragefire Chasm"], "AtlasLootOriginalWoW" };
  -- Razorfen Downs
  ...
  -- Scarlet Monastery Mythic
	AtlasLoot_TableNames["SMLibraryMYTHIC"] = { BabbleZone["Library"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SMGraveyardMYTHIC"] = { BabbleZone["Graveyard"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["SMCathedralMYTHIC"] = { BabbleZone["Cathedral"], "AtlasLootOriginalWoW" };
  -- Scholomance
  ...
  -- Shadowfang Keep Mythic
	AtlasLoot_TableNames["ShadowfangKeep1MYTHIC"] = { BabbleZone["Shadowfang Keep"], "AtlasLootOriginalWoW" };
  -- The Stockade
	AtlasLoot_TableNames["TheStockade"] = { BabbleZone["The Stockade"], "AtlasLootOriginalWoW" };
  -- The Stockade Mythic
	AtlasLoot_TableNames["TheStockadeMYTHIC"] = { BabbleZone["The Stockade"], "AtlasLootOriginalWoW" };
  -- Stratholme
  ...
  -- Zul'Farrak
	...
	AtlasLoot_TableNames["ZFAntusulMYTHIC"] = { BabbleBoss["Antu'sul"], "AtlasLootOriginalWoW" };
  -- Zul'Gurub
...
------------
  ...
  -- AQ40 Sets
	AtlasLoot_TableNames["AQ40Sets"] = { AL["AQ40 Class Sets"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["AQ40Druid"] = { LOCALIZED_CLASS_NAMES_MALE["DRUID"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["AQ40Warrior"] = { LOCALIZED_CLASS_NAMES_MALE["WARRIOR"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["AQ40Hunter"] = { LOCALIZED_CLASS_NAMES_MALE["HUNTER"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["AQ40Mage"] = { LOCALIZED_CLASS_NAMES_MALE["MAGE"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["AQ40Rogue"] = { LOCALIZED_CLASS_NAMES_MALE["ROGUE"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["AQ40Warlock"] = { LOCALIZED_CLASS_NAMES_MALE["WARLOCK"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["AQ40Shaman"] = { LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["AQ40Paladin"] = { LOCALIZED_CLASS_NAMES_MALE["PALADIN"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["AQ40Priest"] = { LOCALIZED_CLASS_NAMES_MALE["PRIEST"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["AQ40Bard"] = { "Bard", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["AQ40Monk"] = { "Monk", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["AQ40DruidRestoration"] = {LOCALIZED_CLASS_NAMES_MALE["DRUID"].." Restoration", "AtlasLootOriginalWoW"};
	AtlasLoot_TableNames["AQ40DruidFeral"] = {LOCALIZED_CLASS_NAMES_MALE["DRUID"].." Feral", "AtlasLootOriginalWoW"};
	AtlasLoot_TableNames["AQ40DruidBalance"] = {LOCALIZED_CLASS_NAMES_MALE["DRUID"].." Balance", "AtlasLootOriginalWoW"};
	AtlasLoot_TableNames["AQ40WarriorProtection"] = {LOCALIZED_CLASS_NAMES_MALE["WARRIOR"].." Protection", "AtlasLootOriginalWoW"};
	AtlasLoot_TableNames["AQ40WarriorDamage"] = {LOCALIZED_CLASS_NAMES_MALE["WARRIOR"].." Damage", "AtlasLootOriginalWoW"};
	AtlasLoot_TableNames["AQ40DkTank"] = {LOCALIZED_CLASS_NAMES_MALE["DEATHKNIGHT"].." Tank", "AtlasLootOriginalWoW"};
	AtlasLoot_TableNames["AQ40DkDamage"] = {LOCALIZED_CLASS_NAMES_MALE["DEATHKNIGHT"].." Damage", "AtlasLootOriginalWoW"};
	AtlasLoot_TableNames["AQ40ShamanTank"] = {LOCALIZED_CLASS_NAMES_MALE["SHAMAN"].." Tank", "AtlasLootOriginalWoW"};
	AtlasLoot_TableNames["AQ40ShamanRestoration"] = {LOCALIZED_CLASS_NAMES_MALE["SHAMAN"].." Restoration", "AtlasLootOriginalWoW"};
	AtlasLoot_TableNames["AQ40ShamanEnhancement"] = {LOCALIZED_CLASS_NAMES_MALE["SHAMAN"].." Enhancement", "AtlasLootOriginalWoW"};
	AtlasLoot_TableNames["AQ40ShamanElemental"] = {LOCALIZED_CLASS_NAMES_MALE["SHAMAN"].." Elemental", "AtlasLootOriginalWoW"};
	AtlasLoot_TableNames["AQ40PaladinProtection"] = {LOCALIZED_CLASS_NAMES_MALE["PALADIN"].." Protection", "AtlasLootOriginalWoW"};
	AtlasLoot_TableNames["AQ40PaladinHoly"] = {LOCALIZED_CLASS_NAMES_MALE["PALADIN"].." Holy", "AtlasLootOriginalWoW"};
	AtlasLoot_TableNames["AQ40PaladinRetribution"] = {LOCALIZED_CLASS_NAMES_MALE["PALADIN"].." Retribution", "AtlasLootOriginalWoW"};
	AtlasLoot_TableNames["AQ40PriestHeal"] = {LOCALIZED_CLASS_NAMES_MALE["PRIEST"].." Heal", "AtlasLootOriginalWoW"};
	AtlasLoot_TableNames["AQ40PriestShadow"] = {LOCALIZED_CLASS_NAMES_MALE["PRIEST"].." Shadow", "AtlasLootOriginalWoW"};
  -- Dungeon Set 1/2
  ...
  -- Mythic Dungeon Set
	AtlasLoot_TableNames["MythicMoonglade"] = { AL["Moonglade Raiment"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["MythicDreamwing"] = { AL["Dreamwing Armor"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["MythicDemonfang"] = { AL["Demonfang Regalia"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["MythicDragonsteel"] = { AL["Dragonsteel Plate"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["MythicGrace"] = { AL["Vestments of Inner Grace"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["MythicBluefang"] = { AL["Bluefang Armor"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["MythicTidefury"] = { AL["Tidefury Raiment"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["MythicPenance"] = { AL["Penance Battlegear"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["MythicRuby"] = { AL["Ruby Plate"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["MythicBold"] = { AL["Bold Armor"], "AtlasLootOriginalWoW" };

  -- T1 Sets
    AtlasLoot_TableNames["T1Druid"] = { LOCALIZED_CLASS_NAMES_MALE["DRUID"], "AtlasLootOriginalWoW" };
    AtlasLoot_TableNames["T1Druid2"] = { LOCALIZED_CLASS_NAMES_MALE["DRUID"], "AtlasLootOriginalWoW" };
    ...
    AtlasLoot_TableNames["T1Paladin2"] = { LOCALIZED_CLASS_NAMES_MALE["PALADIN"], "AtlasLootOriginalWoW" };
    AtlasLoot_TableNames["T1Priest"] = { LOCALIZED_CLASS_NAMES_MALE["PRIEST"], "AtlasLootOriginalWoW" };
    AtlasLoot_TableNames["T1Monk"] = { "Monk", "AtlasLootOriginalWoW" };
    ...
    AtlasLoot_TableNames["T1Shaman2"] = { LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "AtlasLootOriginalWoW" };
    ...
    AtlasLoot_TableNames["T1Warrior2"] = { LOCALIZED_CLASS_NAMES_MALE["WARRIOR"], "AtlasLootOriginalWoW" };
    AtlasLoot_TableNames["T1DK"]= { LOCALIZED_CLASS_NAMES_MALE["DEATHKNIGHT"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T1Bard"] = { "Bard", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T1DruidFeral"] = { LOCALIZED_CLASS_NAMES_MALE["DRUID"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T1DruidBalance"] = { LOCALIZED_CLASS_NAMES_MALE["DRUID"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T1DruidRestoration"] = { LOCALIZED_CLASS_NAMES_MALE["DRUID"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T1PaladinProtection"] = { LOCALIZED_CLASS_NAMES_MALE["PALADIN"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T1PaladinHoly"] = { LOCALIZED_CLASS_NAMES_MALE["PALADIN"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T1PaladinRetribution"] = { LOCALIZED_CLASS_NAMES_MALE["PALADIN"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T1PriestShadow"] = { LOCALIZED_CLASS_NAMES_MALE["PRIEST"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T1PriestHeal"] = { LOCALIZED_CLASS_NAMES_MALE["PRIEST"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T1ShamanRestoration"] = { LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T1ShamanElemental"] = { LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T1ShamanEnhancement"] = { LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T1ShamanTank"] = { LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T1WarriorProtection"] = { LOCALIZED_CLASS_NAMES_MALE["WARRIOR"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T1WarriorDamage"] = { LOCALIZED_CLASS_NAMES_MALE["WARRIOR"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T1DkTank"] = { LOCALIZED_CLASS_NAMES_MALE["DEATHKNIGHT"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T1DkDamage"] = { LOCALIZED_CLASS_NAMES_MALE["DEATHKNIGHT"], "AtlasLootOriginalWoW" };
  -- T2 Sets
    AtlasLoot_TableNames["T2Druid"] = { LOCALIZED_CLASS_NAMES_MALE["DRUID"], "AtlasLootOriginalWoW" };
    AtlasLoot_TableNames["T2Druid2"] = { LOCALIZED_CLASS_NAMES_MALE["DRUID"], "AtlasLootOriginalWoW" };
    ...
    AtlasLoot_TableNames["T2Paladin2"] = { LOCALIZED_CLASS_NAMES_MALE["PALADIN"], "AtlasLootOriginalWoW" };
    AtlasLoot_TableNames["T2Priest"] = { LOCALIZED_CLASS_NAMES_MALE["PRIEST"], "AtlasLootOriginalWoW" };
    AtlasLoot_TableNames["T2Monk"] = { "Monk", "AtlasLootOriginalWoW" };
    ...
    AtlasLoot_TableNames["T2Shaman2"] = { LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "AtlasLootOriginalWoW" };
    ...
    AtlasLoot_TableNames["T2DK"]= { LOCALIZED_CLASS_NAMES_MALE["DEATHKNIGHT"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T2Bard"] = { "Bard", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T2DruidFeral"] = { LOCALIZED_CLASS_NAMES_MALE["DRUID"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T2DruidBalance"] = { LOCALIZED_CLASS_NAMES_MALE["DRUID"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T2DruidRestoration"] = { LOCALIZED_CLASS_NAMES_MALE["DRUID"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T2PaladinProtection"] = { LOCALIZED_CLASS_NAMES_MALE["PALADIN"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T2PaladinHoly"] = { LOCALIZED_CLASS_NAMES_MALE["PALADIN"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T2PaladinRetribution"] = { LOCALIZED_CLASS_NAMES_MALE["PALADIN"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T2PriestShadow"] = { LOCALIZED_CLASS_NAMES_MALE["PRIEST"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T2PriestHeal"] = { LOCALIZED_CLASS_NAMES_MALE["PRIEST"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T2ShamanRestoration"] = { LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T2ShamanElemental"] = { LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T2ShamanEnhancement"] = { LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T2ShamanTank"] = { LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T2WarriorProtection"] = { LOCALIZED_CLASS_NAMES_MALE["WARRIOR"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T2WarriorDamage"] = { LOCALIZED_CLASS_NAMES_MALE["WARRIOR"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T2DkTank"] = { LOCALIZED_CLASS_NAMES_MALE["DEATHKNIGHT"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T2DkDamage"] = { LOCALIZED_CLASS_NAMES_MALE["DEATHKNIGHT"], "AtlasLootOriginalWoW" };
  -- T3 Sets
	...
	AtlasLoot_TableNames["T3DK"] = { LOCALIZED_CLASS_NAMES_MALE["DEATHKNIGHT"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T3Monk"] = { "Monk", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T3Bard"] = { "Bard", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T3DruidFeral"] = { LOCALIZED_CLASS_NAMES_MALE["DRUID"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T3DruidBalance"] = { LOCALIZED_CLASS_NAMES_MALE["DRUID"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T3DruidRestoration"] = { LOCALIZED_CLASS_NAMES_MALE["DRUID"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T3PaladinProtection"] = { LOCALIZED_CLASS_NAMES_MALE["PALADIN"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T3PaladinHoly"] = { LOCALIZED_CLASS_NAMES_MALE["PALADIN"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T3PaladinRetribution"] = { LOCALIZED_CLASS_NAMES_MALE["PALADIN"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T3PriestShadow"] = { LOCALIZED_CLASS_NAMES_MALE["PRIEST"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T3PriestHeal"] = { LOCALIZED_CLASS_NAMES_MALE["PRIEST"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T3ShamanRestoration"] = { LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T3ShamanElemental"] = { LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T3ShamanEnhancement"] = { LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T3ShamanTank"] = { LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T3WarriorProtection"] = { LOCALIZED_CLASS_NAMES_MALE["WARRIOR"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T3WarriorDamage"] = { LOCALIZED_CLASS_NAMES_MALE["WARRIOR"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T3DkTank"] = { LOCALIZED_CLASS_NAMES_MALE["DEATHKNIGHT"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T3DkDamage"] = { LOCALIZED_CLASS_NAMES_MALE["DEATHKNIGHT"], "AtlasLootOriginalWoW" };
  -- T4/T5/T6 Sets
  ...
  -- Mythic Token Rewards
	AtlasLoot_TableNames["+2"] = { "Mythic +2 Rewards", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["+2PAGE2"] = { "Mythic +2 Rewards", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["+4"] = { "Mythic +4 Rewards", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["+4PAGE2"] = { "Mythic +4 Rewards", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["+6"] = { "Mythic +6 Rewards", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["+6PAGE2"] = { "Mythic +6 Rewards", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["+8"] = { "Mythic +8 Rewards", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["+8PAGE2"] = { "Mythic +8 Rewards", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["KeystoneChallenge"] = { "Keystone Challenge Rewards", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["+10"] = { "Mythic +10 Rewards", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["+10PAGE2"] = { "Mythic +10 Rewards", "AtlasLootOriginalWoW" };
...
--------------------
  ...
  -- Kazzak Vanilla
	AtlasLoot_TableNames["LordKazzak"]	= { BabbleBoss["Lord Kazzak"], "AtlasLootOriginalWoW" };
  -- Kazzak/Doomwalker
...
-------------
  ...
  -- Menus, the entry does nothing, but makes the generalised loot table code less complex
	AtlasLoot_TableNames["T1SET"] = { "Tier 1 Sets", "Menu" };
	AtlasLoot_TableNames["T2SET"] = { "Tier 2 Sets", "Menu" };
	AtlasLoot_TableNames["T3SET"] = { "Tier 3 Sets", "Menu" };
	AtlasLoot_TableNames["T1Dk"] = { "Tier 1 Sets", "Menu" };
	AtlasLoot_TableNames["T1Paladin"] = { "Tier 1 Sets", "Menu" };
	AtlasLoot_TableNames["T1Druid"] = { "Tier 1 Sets", "Menu" };
	AtlasLoot_TableNames["T1Shaman"] = { "Tier 1 Sets", "Menu" };
	AtlasLoot_TableNames["T1Warrior"] = { "Tier 1 Sets", "Menu" };
	AtlasLoot_TableNames["T1Priest"] = { "Tier 1 Sets", "Menu" };
	AtlasLoot_TableNames["T2Dk"] = { "Tier 2 Sets", "Menu" };
	AtlasLoot_TableNames["T2Paladin"] = { "Tier 2 Sets", "Menu" };
	AtlasLoot_TableNames["T2Druid"] = { "Tier 2 Sets", "Menu" };
	AtlasLoot_TableNames["T2Shaman"] = { "Tier 2 Sets", "Menu" };
	AtlasLoot_TableNames["T2Warrior"] = { "Tier 2 Sets", "Menu" };
	AtlasLoot_TableNames["T2Priest"] = { "Tier 2 Sets", "Menu" };
	AtlasLoot_TableNames["T3Dk"] = { "Tier 3 Sets", "Menu" };
	AtlasLoot_TableNames["T3Paladin"] = { "Tier 3 Sets", "Menu" };
	AtlasLoot_TableNames["T3Druid"] = { "Tier 3 Sets", "Menu" };
	AtlasLoot_TableNames["T3Shaman"] = { "Tier 3 Sets", "Menu" };
	AtlasLoot_TableNames["T3Warrior"] = { "Tier 3 Sets", "Menu" };
	AtlasLoot_TableNames["T3Priest"] = { "Tier 3 Sets", "Menu" };
	AtlasLoot_TableNames["AQ40Sets"] = { "Ahn'Qiraj Sets", "Menu"};
	...
	AtlasLoot_TableNames["MYTHICSET"] = { AL["Mythic Dungeon Sets"], "Menu" };
	AtlasLoot_TableNames["KSC"] = { "Keystone Challenge Rewards", "Menu" };
	AtlasLoot_TableNames["MYTHICMENU"] = { AL["Mythic Rewards"], "Menu" };
