...
---- Azuregos
	...
	AtlasLoot_Data["AQ20KurinnaxxHEROIC"] = {
		{ 1, 57235, "", "=q4=Qiraji Sacrificial Dagger", "=ds=#h1#, #w4#", "", "100%"};
		Next = "AQ20RajaxxHEROIC";
	};
	AtlasLoot_Data["AQ20RajaxxHEROIC"] = {
		{ 1, 57236, "", "=q4=Manslayer of the Qiraji", "=ds=#h2#, #w10#", "", "100%"};
		{ 16, 0, "INV_Box_01", "=q6="..AL["Rajaxx's Captains"], ""};
		{ 17, 57237, "", "=q3=Fury of the Forgotten Swarm", "=ds=#s2#", "", "100%"};
		{ 18, 57238, "", "=q3=Gavel of Qiraji Authority", "=ds=#h2#, #w6#", "", "100%"};
		Prev = "AQ20KurinnaxxHEROIC";
		Next = "AQ20MoamHEROIC";
	};
	AtlasLoot_Data["AQ20MoamHEROIC"] = {
		{ 1, 57239, "", "=q4=Talon of Furious Concentration", "=ds=#s15#", "", "100%"};
		{ 2, 57240, "", "=q3=Ring of Fury", "=ds=#s13#", "", "100%"};
		{ 3, 57241, "", "=q3=Eye of Moam", "=ds=#s14#", "", "100%"};
		Prev = "AQ20RajaxxHEROIC";
		Next = "AQ20BuruHEROIC";
	};
	AtlasLoot_Data["AQ20BuruHEROIC"] = {
		{ 1, 57242, "", "=q4=Buru's Skull Fragment", "=ds=#w8#", "", "100%"};
		{ 2, 57243, "", "=q3=Fetish of Chitinous Spikes", "=ds=#s14#", "", "100%"};
		Prev = "AQ20MoamHEROIC";
		Next = "AQ20AyamissHEROIC";
	};
	AtlasLoot_Data["AQ20AyamissHEROIC"] = {
		{ 1, 57244, "", "=q4=Stinger of Ayamiss", "=ds=#h3#, #w6#", "", "100%"};
		{ 2, 57245, "", "=q4=Bow of Taut Sinew", "=ds=#w2#", "", "100%"};
		{ 3, 57246, "", "=q3=Ring of the Desert Winds", "=ds=#s13#", "", "100%"};
		Prev = "AQ20BuruHEROIC";
		Next = "AQ20OssirianHEROIC";
	};
	AtlasLoot_Data["AQ20OssirianHEROIC"] = {
		{ 1, 57247, "", "=q4=Sand Polished Hammer", "=ds=#h1#, #w6#", "", "100%"};
		{ 2, 57248, "", "=q4=Crossbow of Imminent Doom", "=ds=#w3#", "", "100%"};
		{ 3, 57249, "", "=q4=Staff of the Ruins", "=ds=#w9#", "", "100%"};
	...
	AtlasLoot_Data["AQ40SkeramHEROIC"] = {
		{ 1, 57250, "", "=q4=Amulet of Foul Warding", "=ds=#s2#", "", "100%"};
		{ 2, 57251, "", "=q4=Pendant of the Qiraji Guardian", "=ds=#s2#", "", "100%"};
		{ 3, 57252, "", "=q4=Ring of Swarming Thought", "=ds=#s13#", "", "100%"};
		{ 4, 57253, "", "=q4=Hammer of Ji'zhi", "=ds=#h2#, #w6#", "", "100%"};
		{ 5, 57254, "", "=q4=Staff of the Qiraji Prophets", "=ds=#w9#", "", "100%"};
		Next = "AQ40VemHEROIC";
	};

	AtlasLoot_Data["AQ40VemHEROIC"] = {
		{ 1, 57255, "", "=q4=Angelista's Touch", "=ds=#s13# =q2=#m5#", "", "100%"};
		{ 2, 57257, "", "=q4=Wand of Qiraji Nobility", "=ds=#w12# =q2=#n115#", "", "100%"};
		Prev = "AQ40SkeramHEROIC";
		Next = "AQ40SarturaHEROIC";
	};

	AtlasLoot_Data["AQ40SarturaHEROIC"] = {
		{ 1, 57258, "", "=q4=Badge of the Swarmguard", "=ds=#s14#", "", "100%"};
		{ 2, 57259, "", "=q4=Sartura's Might", "=ds=#s15#", "", "100%"};
		{ 3, 57260, "", "=q4=Silithid Claw", "=ds=#h3#, #w13#", "", "100%"};
		Prev = "AQ40VemHEROIC";
		Next = "AQ40FankrissHEROIC";
	};

	AtlasLoot_Data["AQ40FankrissHEROIC"] = {
		{ 1, 57261, "", "=q4=Barbed Choker", "=ds=#s2#", "", "100%"};
		{ 2, 57262, "", "=q4=Ancient Qiraji Ripper", "=ds=#h1#, #w10#", "", "100%"};
		{ 3, 57263, "", "=q4=Barb of the Sand Reaver", "=ds=#w7#", "", "100%"};
		Prev = "AQ40SarturaHEROIC";
		Next = "AQ40ViscidusHEROIC";
	};

	AtlasLoot_Data["AQ40ViscidusHEROIC"] = {
		{ 1, 57264, "", "=q4=Ring of the Qiraji Fury", "=ds=#s13#", "", "100%"};
		{ 2, 57265, "", "=q4=Scarab Brooch", "=ds=#s14#", "", "100%"};
		{ 3, 57266, "", "=q4=Sharpened Silithid Femur", "=ds=#h3#, #w10#", "", "100%"};
		Prev = "AQ40FankrissHEROIC";
		Next = "AQ40HuhuranHEROIC";
	};

	AtlasLoot_Data["AQ40HuhuranHEROIC"] = {
		{ 1, 57267, "", "=q4=Huhuran's Stinger", "=ds=#w2#", "", "100%"};
		Prev = "AQ40ViscidusHEROIC";
		Next = "AQ40EmperorsHEROIC";
	};

	AtlasLoot_Data["AQ40EmperorsHEROIC"] = {
		{ 2, 57268, "", "=q4=Kalimdor's Revenge", "=ds=#h2#, #w10#", "", "100%"};
		{ 3, 57269, "", "=q4=Amulet of Vek'nilash", "=ds=#s2#", "", "100%"};
		Prev = "AQ40HuhuranHEROIC";
		Next = "AQ40OuroHEROIC";
	};

	AtlasLoot_Data["AQ40OuroHEROIC"] = {
		{ 1, 57275, "", "=q4=Jom Gabbar", "=ds=#s14#", "", "100%"};
		{ 2, 57270, "", "=q4=Larvae of the Great Worm", "=ds=#w5#", "", "100%"};
		{ 3, 57271, "", "=q4=Wormscale Blocker", "=ds=#w8#", "", "100%"};
		Prev = "AQ40EmperorsHEROIC";
		Next = "AQ40CThunHEROIC";
	};

	AtlasLoot_Data["AQ40CThunHEROIC"] = {
		{ 1, 57276, "", "=q4=Mark of Korthex", "=ds=#s2#", "", "100%"};
		{ 2, 57277, "", "=q4=Vanquished Tentacle of C'Thun", "=ds=#s14#", "", "100%"};
		{ 3, 57272, "", "=q4=Death's Sting", "=ds=#h1#, #w4#", "", "100%"};
		{ 4, 57273, "", "=q4=Dark Edge of Insanity", "=ds=#h2#, #w1#", "", "100%"};
	...
	AtlasLoot_Data["AQOpening"] = {
		...
		--- Azshara Crater ---
		----------------------
	AtlasLoot_Data["ArchdruidMalodar"] = {
		...
		Next = "CaptainMoonstrike";
	};
	
	AtlasLoot_Data["CaptainMoonstrike"] = {
		...
		{ 22, 57720, "", "=q4=Scarlet Handguards", "=q1=#m1# =ds=#c5# (T1)", "", "18.65%"};
		{ 24, 17331, "", "=q1=Hand of Gehennas", "=ds=#m3#"};
	
		Next = "Melandrus";
		Prev = "ArchdruidMalodar";
	};
	
	AtlasLoot_Data["Melandrus"] = {
		...
		Next = "TwilightLordEverun";
		Prev = "CaptainMoonstrike";
	};
	
	AtlasLoot_Data["TwilightLordEverun"] = {
		...
		{ 14, 57724, "", "=q4=Cane of Dominance", "=ds=#w9#", "", "18.95%"};
		{ 16, 17072, "", "=q4=Blastershot Launcher", "=ds=#w5#", "", "17.83%"};
		{ 17, 16798, "", "=q4=Arcanist Robes", "=q1=#m1# =ds=#c3# (T1)", "", "16.51%"};
		{ 18, 16815, "", "=q4=Robes of Prophecy", "=q1=#m1# =ds=#c5# (T1)", "", "15.65%"};
		{ 19, 16809, "", "=q4=Felheart Robes", "=q1=#m1# =ds=#c8# (T1)", "", "15.66%"};
		{ 20, 16820, "", "=q4=Nightslayer Chestpiece", "=q1=#m1# =ds=#c6# (T1)", "", "16.76%"};
		{ 21, 16833, "", "=q4=Cenarion Vestments", "=q1=#m1# =ds=#c1# (T1)", "", "15.21%"};
		{ 22, 16845, "", "=q4=Giantstalker's Breastplate", "=q1=#m1# =ds=#c2# (T1)", "", "15.83%"};
		{ 23, 16841, "", "=q4=Earthfury Vestments", "=q1=#m1# =ds=#c7# (T1)", "", " 6.08%"};
		{ 24, 16865, "", "=q4=Breastplate of Might", "=q1=#m1# =ds=#c9# (T1)", "", "15.28%"};
		{ 25, 16853, "", "=q4=Lawbringer Chestguard", "=q1=#m1# =ds=#c4# (T1)", "", "9.53%"};
		{ 26, 16815, "", "=q4=Scarlet Vest", "=q1=#m1# =ds=#c5# (T1)", "", "15.65%"};
		{ 27, 17203, "", "=q4=Sulfuron Ingot", "=ds=#m3#", "", "11.98%"};
		{ 28, 17182, "", "=q5=Sulfuras, Hand of Ragnaros", "=q1=#m4#: =ds=#h2#, #w6#"};
		Next = "Trythendra";
		Prev = "Melandrus";
	};
	
	AtlasLoot_Data["Trythendra"] = {
		...
		{ 25, 57722, "", "=q4=Scarlet Legguards", "=q1=#m1# =ds=#c5# (T1)", "", "14.33%"};
	
		Next = "ElderSookh";
		Prev = "TwilightLordEverun";
	};
	
	AtlasLoot_Data["ElderSookh"] = {
		...
		{ 25, 57716, "", "=q4=Scarlet Mask", "=q1=#m1# =ds=#c5# (T1)", "", "11.36%"};
		{ 27, 18564, "", "=q5=Bindings of the Windseeker", "=ds=#m3#, =q1=#m9#", "", "3.74%"};
		{ 28, 19019, "", "=q5=Thunderfury, Blessed Blade of the Windseeker", "=q1=#m4#: =ds=#h1#, #w10#"};
	...
	AtlasLoot_Data["WrathofAzshara"] = {
		...
		{ 10, 57721, "", "=q4=Scarlet Girdle", "=q1=#m1# =ds=#c5# (T1)", "", "0.18%"};
		{ 12, 17010, "", "=q3=Fiery Core", "=ds=#e8#"};
		{ 13, 17011, "", "=q3=Lava Core", "=ds=#e8#"};
		{ 14, 11382, "", "=q2=Blood of the Mountain", "=ds=#e8#"};
		{ 15, 17012, "", "=q1=Core Leather", "=ds=#e8#"};
		...
		{ 25, 57719, "", "=q4=Scarlet Vambraces", "=q1=#m1# =ds=#c5# (T1)", "", "0.16%"};
...
--[[	AtlasLoot_Data["BlackfathomDeeps1MYTHIC"] = {
		{ 2, 0, "INV_Box_01", "=q6=Chest of the Conqueror", "#j55#"};
		{ 3, 56812, "", "=q4=Cursed Felblade", "=ds=#h1#, #w10#", "", ""};
		{ 4, 56815, "", "=q4=Magma Shield", "=ds=#w8#", "", ""};
		{ 5, 56807, "", "=q4=Crystalline Cuffs", "=ds=#s8#, #a1#", "", ""};
		{ 17, 0, "INV_Box_01", "=q6=Chest of the Conqueror", "#j56#"};
		{ 18, 56812, "", "=q4=Cursed Felblade", "=ds=#h1#, #w10#", "", ""};
		{ 19, 57012, "", "=q4=Magma Shield (S2)", "=ds=#w8#", "", ""};
		{ 20, 56807, "", "=q4=Crystalline Cuffs", "=ds=#s8#, #a1#", "", ""};
	};]]--
	...
	AtlasLoot_Data["MCShazzrah"] = {
		...
		{ 22, 57723, "", "=q4=Scarlet Boots", "=q1=#m1# =ds=#c5# (T1)", "", "14.90%"};
		{ 24, 17332, "", "=q1=Hand of Shazzrah", "=ds=#m3#"};
		Prev = "MCGarr";
		Next = "MCGeddon";
	};
	...
	AtlasLoot_Data["MCSulfuron"] = {
		...
		{ 20, 57717, "", "=q4=Scarlet Mantle", "=q1=#m1# =ds=#c5# (T1)", "", "21.06%"};
		{ 22, 17330, "", "=q1=Hand of Sulfuron", "=ds=#m3#"};
		Prev = "MCGolemagg";
		Next = "MCMajordomo";
	};
	...
	AtlasLoot_Data["MCRhannoxHEROIC"] = {
--		{ 1, 19136, "", "=q4=Mana Igniting Cord", "=ds=#s10#, #a1#", "", "2.44%"};
--		{ 2, 18823, "", "=q4=Aged Core Leather Gloves", "=ds=#s9#, #a2#", "", "3.04%"};
--		{ 3, 18829, "", "=q4=Deep Earth Spaulders", "=ds=#s3#, #a3#", "", "1.04%"};
--		{ 4, 19144, "", "=q4=Sabatons of the Flamewalker", "=ds=#s12#, #a3#", "", "1.00%"};
...
--		{ 7, 18824, "", "=q4=Magma Tempered Boots", "=ds=#s12#, #a4#", "", "1.48%"};
--		{ 8, 17110, "", "=q4=Seal of the Archmagus", "=ds=#s13#", "", "21.93%"};
		{ 1, 57057, "", "=q4=Quick Strike Ring", "=ds=#s13#", "", "100%"};
--		{ 10, 18820, "", "=q4=Talisman of Ephemeral Power", "=ds=#s14#", "", "2.68%"};
--		{ 11, 19142, "", "=q4=Fire Runed Grimoire", "=ds=#s15#", "", "2.59%"};
		{ 2, 57058, "", "=q4=Obsidian Edged Blade", "=ds=#h2#, #w10#", "", "100%"};
		{ 16, 18563, "", "=q5=Bindings of the Windseeker", " =ds=#m3#, =q1=#m10#", "", "??.??%"};
		{ 17, 19019, "", "=q5=Thunderfury, Blessed Blade of the Windseeker", "=q1=#m4#: =ds=#h1#, #w10#"};
		Next = "MCLucifronHEROIC";
	};
...
--		{ 5, 18870, "", "=q4=Helm of the Lifegiver", "=ds=#s1#, #a3#", "", "1.09%"};
--		{ 6, 18861, "", "=q4=Flamewaker Legplates", "=ds=#s11#, #a4#", "", "2.15%"};
--		{ 7, 57055, "", "=q4=Choker of Enlightenment", "=ds=#s2#", "", "100%"};
		{ 1, 57054, "", "=q4=Heavy Dark Iron Ring", "=ds=#s13#", "", "100%"};
		{ 2, 57053, "", "=q4=Ring of Spell Power", "=ds=#s13#", "", "100%"};
		{ 3, 57052, "", "=q4=Sorcerous Dagger", "=ds=#h3#, #w4#", "", "100%"};
		{ 5, 18259, "", "=q3=Formula: Enchant Weapon - Spell Power", "=ds=#p4# (300)", "", "100%"};
		{ 6, 18260, "", "=q3=Formula: Enchant Weapon - Healing Power", "=ds=#p4# (300)", "", "100%"};
--		{ 11, 17077, "", "=q4=Crimson Shocker", "=ds=#w12#", "", "1.60%"};
		{ 16, 17329, "", "=q1=Hand of Lucifron", "=ds=#m3#"};
		Prev = "MCRhannoxHEROIC";
...
--		{ 6, 18861, "", "=q4=Flamewaker Legplates", "=ds=#s11#, #a4#", "", "3.98%"};
--		{ 7, 18824, "", "=q4=Magma Tempered Boots", "=ds=#s12#, #a4#", "", "3.22%"};
		{ 1, 57056, "", "=q4=Medallion of Steadfast Might", "=ds=#s2#", "", "100%"};
--		{ 9, 57057, "", "=q4=Quick Strike Ring", "=ds=#s13#", "", "5.79%"};
--		{ 10, 18820, "", "=q4=Talisman of Ephemeral Power", "=ds=#s14#", "", "5.55%"};
--		{ 11, 19142, "", "=q4=Fire Runed Grimoire", "=ds=#s15#", "", "5.42%"};
--		{ 12, 18203, "", "=q4=Eskhandar's Right Claw", "=ds=#h3#, #w13#", "", "17.82%"};
--		{ 13, 57058, "", "=q4=Obsidian Edged Blade", "=ds=#h2#, #w10#", "", "5.68%"};
		{ 2, 57059, "", "=q4=Earthshaker", "=ds=#h2#, #w6#", "", "100%"};
		{ 3, 57060, "", "=q4=Striker's Mark", "=ds=#w2#", "", "100%"};
		{ 5, 18252, "", "=q3=Pattern: Core Armor Kit", "=ds=#p7# (300)", "", "100%"};
...
--		{ 6, 18861, "", "=q4=Flamewaker Legplates", "=ds=#s11#, #a4#", "", "3.48%"};
		{ 1, 57054, "", "=q4=Heavy Dark Iron Ring", "=ds=#s13#", "", "100%"};
		{ 2, 57053, "", "=q4=Ring of Spell Power", "=ds=#s13#", "", "100%"};
		{ 3, 57055, "", "=q4=Choker of Enlightenment", "=ds=#s2#", "", "100%"};
--		{ 9, 57052, "", "=q4=Sorcerous Dagger", "=ds=#h3#, #w4#", "", "3.79%"};
--		{ 10, 17077, "", "=q4=Crimson Shocker", "=ds=#w12#", "", "3.34%"};
		{ 16, 17331, "", "=q1=Hand of Gehennas", "=ds=#m3#"};
...
--		{ 6, 18861, "", "=q4=Flamewaker Legplates", "=ds=#s11#, #a4#", "", "2.82%"};
--		{ 7, 18824, "", "=q4=Magma Tempered Boots", "=ds=#s12#, #a4#", "", "3.05%"};
--		{ 8, 57057, "", "=q4=Quick Strike Ring", "=ds=#s13#", "", "4.48%"};
--		{ 9, 18820, "", "=q4=Talisman of Ephemeral Power", "=ds=#s14#", "", "4.13%"};
--		{ 10, 19142, "", "=q4=Fire Runed Grimoire", "=ds=#s15#", "", "3.69%"};
		{ 1, 57061, "", "=q4=Gutgore Ripper", "=ds=#h1#, #w4#", "", "100%"};
		{ 2, 57062, "", "=q4=Brutality Blade", "=ds=#h1#, #w10#", "", "100%"};
--		{ 13, 57058, "", "=q4=Obsidian Edged Blade", "=ds=#h2#, #w10#", "", "4.09%"};
--		{ 14, 57063, "", "=q4=Aurastone Hammer", "=ds=#h3#, #w6#", "", "12.67%"};
		{ 3, 57064, "", "=q4=Drillborer Disk", "=ds=#w8#", "", "100%"};
		{ 5, 18290, "", "=q3=Schematic: Biznicks 247x128 Accurascope", "=ds=#p5# (300)", "", "100%"};
		{ 6, 18264, "", "=q3=Plans: Elemental Sharpening Stone", "=ds=#p2# (300)", "", "100%"};
		{ 16, 18564, "", "=q5=Bindings of the Windseeker", "=ds=#m3#, =q1=#m9#", "", "3.74%"};
		{ 17, 19019, "", "=q5=Thunderfury, Blessed Blade of the Windseeker", "=q1=#m4#: =ds=#h1#, #w10#"};
...
--		{ 6, 18861, "", "=q4=Flamewaker Legplates", "=ds=#s11#, #a4#", "", "2.22%"};
		...
		{ 6, 18260, "", "=q3=Formula: Enchant Weapon - Healing Power", "=ds=#p4# (300)", "", "100%"};
--		{ 10, 17077, "", "=q4=Crimson Shocker", "=ds=#w12#", "", "3.32%"};
		{ 16, 17332, "", "=q1=Hand of Shazzrah", "=ds=#m3#"};
		Prev = "MCGarrHEROIC";
		Next = "MCGeddonHEROIC";
	};
...
--		{ 11, 19142, "", "=q4=Fire Runed Grimoire", "=ds=#s15#", "", "2.59%"};
		{ 2, 57058, "", "=q4=Obsidian Edged Blade", "=ds=#h2#, #w10#", "", "100%"};
		{ 16, 18563, "", "=q5=Bindings of the Windseeker", " =ds=#m3#, =q1=#m10#", "", "3.78%"};
		{ 17, 19019, "", "=q5=Thunderfury, Blessed Blade of the Windseeker", "=q1=#m4#: =ds=#h1#, #w10#"};
...
--		{ 6, 18861, "", "=q4=Flamewaker Legplates", "=ds=#s11#, #a4#", "", "1.44%"};
--		{ 7, 18824, "", "=q4=Magma Tempered Boots", "=ds=#s12#, #a4#", "", "1.69%"};
--		{ 8, 57057, "", "=q4=Quick Strike Ring", "=ds=#s13#", "", "2.26%"};
--		{ 9, 18820, "", "=q4=Talisman of Ephemeral Power", "=ds=#s14#", "", "2.91%"};
--		{ 10, 19142, "", "=q4=Fire Runed Grimoire", "=ds=#s15#", "", "2.46%"};
		{ 1, 57065, "", "=q4=Azuresong Mageblade", "=ds=#h3#, #w10#", "", "100%"};
--		{ 12, 57058, "", "=q4=Obsidian Edged Blade", "=ds=#h2#, #w10#", "", "2.89%"};
		{ 2, 57066, "", "=q4=Staff of Dominance", "=ds=#w9#", "", "100%"};
		{ 3, 57067, "", "=q4=Blastershot Launcher", "=ds=#w5#", "", "100%"};
		{ 16, 17203, "", "=q4=Sulfuron Ingot", "=ds=#m3#", "", "11.98%"};
...
--		{ 5, 18870, "", "=q4=Helm of the Lifegiver", "=ds=#s1#, #a3#", "", "1.26%"};
--		{ 6, 18861, "", "=q4=Flamewaker Legplates", "=ds=#s11#, #a4#", "", "2.54%"};
--		{ 7, 57054, "", "=q4=Heavy Dark Iron Ring", "=ds=#s13#", "", "2.32%"};
		{ 3, 57053, "", "=q4=Ring of Spell Power", "=ds=#s13#", "", "100%"};
--		{ 9, 57052, "", "=q4=Sorcerous Dagger", "=ds=#h3#, #w4#", "", "2.53%"};
		{ 2, 57055, "", "=q4=Choker of Enlightenment", "=ds=#s2#", "", "100%"};
		{ 1, 57068, "", "=q4=Shadowstrike", "=ds=#w7#", "", "100%"};
--		{ 11, 17077, "", "=q4=Crimson Shocker", "=ds=#w12#", "", "2.26%"};
		{ 5, 18257, "", "=q3=Recipe: Major Rejuvenation Potion", "=ds=#p1# (300)", "", "100%"};
		{ 16, 17330, "", "=q1=Hand of Sulfuron", "=ds=#m3#"};
...
--		{ 6, 18812, "", "=q4=Wristguards of True Flight", "=ds=#s8#, #a3#", "", "18.04%"};
--		{ 7, 18806, "", "=q4=Core Forged Greaves", "=ds=#s12#, #a4#", "", "16.53%"};
		{ 1, 57069, "", "=q4=Cauterizing Band", "=ds=#s13#", "", "100%"};
		{ 2, 57070, "", "=q4=Core Hound Tooth", "=ds=#h1#, #w4#", "", "100%"};
		{ 3, 57071, "", "=q4=Finkle's Lava Dredger", "=ds=#h2#, #w6#", "", "100%"};
		{ 16, 18703, "", "=q4=Ancient Petrified Leaf", "=ds=#m2# =q1=(#c2#)", "", "100%"};
		{ 17, 18715, "", "=q4=Lok'delar, Stave of the Ancient Keepers", "=q1=#m4#: =ds=#w9#, =q1=#m1# =ds=#c2#"};
		{ 18, 18713, "", "=q4=Rhok'delar, Longbow of the Ancient Keepers", "=q1=#m4#: =ds=#w2#, =q1=#m1# =ds=#c2#"};
		{ 19, 18714, "", "=q4=Ancient Sinew Wrapped Lamina", "=q1=#m4#: =ds=#w19#, =q1=#m1# =ds=#c2#"};
		{ 21, 18646, "", "=q4=The Eye of Divinity", "=ds=#m2# =q1=(#c5#)", "", "100%"};
		{ 22, 18608, "", "=q4=Benediction", "=q1=#m4#: =ds=#w9#, =q1=#m1# =ds=#c5#"};
		{ 23, 18609, "", "=q4=Anathema", "=q1=#m4#: =ds=#w9#, =q1=#m1# =ds=#c5#"};
...
--		{ 10, 31102, "", "=q4=Token of the Forgotten Vanquisher", "=ds=Tier 2 Token", "", "50%"};
		{ 16, 57080, "", "=q4=The Black Book", "=ds=#s14#, =q1=#m1# =ds=#c8#", "", "100%"};
		{ 17, 57081, "", "=q4=Arcane Infused Gem", "=ds=#s14#, =q1=#m1# =ds=#c2#", "", "100%"};
--		{ 19, 19370, "", "=q4=Mantle of the Blackwing Cabal", "=ds=#s3#, #a1#", "", "18.57%"};
--		{ 20, 19369, "", "=q4=Gloves of Rapid Evolution", "=ds=#s9#, #a1#", "", "17.52%"};
		{ 1, 57089, "", "=q4=The Untamed Blade", "=ds=#h2#, #w10#", "", "100%"};
		{ 2, 57090, "", "=q4=Spineshatter", "=ds=#h1#, #w6#", "", "100%"};
...
--		{ 9, 16952, "", "=q4=Judgement Belt", "=q1=#m1# =ds=#c4#", "", "12.23%"};
--		{ 10, 31102, "", "=q4=Token of the Forgotten Vanquisher", "=ds=Tier 2 Token", "", "50%"};
		{ 16, 57082, "", "=q4=Mind Quickening Gem", "=ds=#s14#, =q1=#m1# =ds=#c3#", "", "100%"};
		{ 17, 57083, "", "=q4=Rune of Metamorphosis", "=ds=#s14#, =q1=#m1# =ds=#c1#", "", "100%"};
--		{ 19, 19372, "", "=q4=Helm of Endless Rage", "=ds=#s1#, #a4#", "", "16.76%"};
		{ 3, 57091, "", "=q4=Pendant of the Fallen Dragon", "=ds=#s2#", "", "100%"};
		{ 1, 57092, "", "=q4=Dragonfang Blade", "=ds=#h1#, #w4#", "", "100%"};
		{ 2, 57093, "", "=q4=Red Dragonscale Protector", "=ds=#w8#", "", "100%"};
...
--		{ 10, 31102, "", "=q4=Token of the Forgotten Vanquisher", "=ds=Tier 2 Token", "", "50%"};
		...
		{ 16, 57084, "", "=q4=Venomous Totem", "=ds=#s14#, =q1=#m1# =ds=#c6#", "", "100%"};
		{ 17, 57085, "", "=q4=Lifegiving Gem", "=ds=#s14#, =q1=#m1# =ds=#c9#", "", "100%"};
--		{ 19, 19374, "", "=q4=Bracers of Arcane Accuracy", "=ds=#s8#, #a1#", "", "15.03%"};
--		{ 20, 19373, "", "=q4=Black Brood Pauldrons", "=ds=#s3#, #a3#", "", "17.25%"};
		{ 1, 57094, "", "=q4=Maladath, Runed Blade of the Black Flight", "=ds=#h1#, #w10#", "", "100%"};
		{ 2, 57095, "", "=q4=Heartstriker", "=ds=#w2#", "", "100%"};
...
--		{ 25, 19402, "", "=q4=Legguards of the Fallen Crusader", "=ds=#s11#, #a4#", "", "9.50%"};
--		{ 27, 19397, "", "=q4=Ring of Blackrock", "=ds=#s13#", "", "5.98%"};
		{ 4, 57096, "", "=q4=Rejuvenating Gem", "=ds=#s14#", "", "5.30%"};
...
--		{ 23, 19403, "", "=q4=Band of Forced Concentration", "=ds=#s13#", "", "14.63%"};
--		{ 24, 19397, "", "=q4=Ring of Blackrock", "=ds=#s13#", "", "5.99%"};
		{ 5, 57120, "", "=q4=Drake Fang Talisman", "=ds=#s14#", "", "17.41%"};
...
--		{ 21, 19397, "", "=q4=Ring of Blackrock", "=ds=#s13#", "", "6.25%"};
--		{ 22, 19432, "", "=q4=Circle of Applied Force", "=ds=#s13#", "", "18.69%"};
		{ 5, 57096, "", "=q4=Rejuvenating Gem", "=ds=#s14#", "", "5.46%"};
--		{ 24, 19431, "", "=q4=Styleen's Impeding Scarab", "=ds=#s14#", "", "17.02%"};
		{ 2, 57099, "", "=q4=Drake Talon Cleaver", "=ds=#h2#, #w1#", "", "3.79%"};
		{ 1, 57101, "", "=q4=Herald of Woe", "=ds=#h2#, #w6#", "", "9.07%"};
...
--		{ 23, 19392, "", "=q4=Girdle of the Fallen Crusader", "=ds=#s10#, #a4#", "", "10.97%"};
--		{ 24, 19387, "", "=q4=Chromatic Boots", "=ds=#s12#, #a4#", "", "16.46%"};
		{ 1, 57103, "", "=q4=Claw of Chromaggus", "=ds=#h3#, #w4#", "", "100%"};
		{ 2, 57104, "", "=q4=Chromatically Tempered Sword", "=ds=#h1#, #w10#", "", "100%"};
		{ 4, 57105, "", "=q4=Elementium Reinforced Bulwark", "=ds=#w8#", "", "100%"};
		{ 3, 57106, "", "=q4=Ashjre'thul, Crossbow of Smiting", "=ds=#w3#", "", "100%"};
		Prev = "BWLFlamegorHEROIC";
...
--		{ 21, 19376, "", "=q4=Archimtiros' Ring of Reckoning", "=ds=#s13#", "", "13.93%"};
--		{ 22, 19382, "", "=q4=Pure Elementium Band", "=ds=#s13#", "", "15.15%"};
		{ 5, 57107, "", "=q4=Neltharion's Tear", "=ds=#s14#", "", "100%"};
		{ 1, 57108, "", "=q4=Ashkandi, Greatsword of the Brotherhood", "=ds=#h2#, #w10#", "", "100%"};
		{ 4, 57109, "", "=q4=Crul'shorukh, Edge of Chaos", "=ds=#h1#, #w1#", "", "100%"};
		{ 3, 57110, "", "=q4=Lok'amir il Romathis", "=ds=#h3#, #w6#", "", "100%"};
		{ 2, 57111, "", "=q4=Staff of the Shadow Flame", "=ds=#w9#", "", "100%"};
...
--		Prev = "Naxx60Gluth2";
	...
	AtlasLoot_Data["Naxx60Trash"] = {
		...
		AtlasLoot_Data["OnyxiaL60"] = {
		{ 1, 17078, "", "=q4=Sapphiron Drape", "=ds=#s4#", "", "14.95%"};
		{ 2, 18205, "", "=q4=Eshkandar's Collar", "=ds=#s2#", "", "14.33%"};
		{ 3, 18813, "", "=q4=Ring of Binding", "=ds=#s13#", "", "15.15%"};
		{ 4, 17064, "", "=q4=Shard of the Scale", "=ds=#s14#", "", "14.26%"};
		{ 5, 17067, "", "=q4=Ancient Cornerstone Grimoire", "=ds=#h4#", "", "7.21%"};
		{ 6, 17068, "", "=q4=Deathbringer", "=ds=#h1#, #w1#", "", "7.00%"};
		{ 7, 17075, "", "=q4=Vis'kag th Bloodletter", "=ds=#h1#, #w10#", "", "6.98%"};
		{ 9, 31102, "", "=q4=Token of the Forgotten Vanquisher", "=ds=Tier 2 Token", "", "100%"};
		{ 13, 18705, "", "=q4=Mature Black Dragon Sinew", "=ds=#m3# =q1=(#c2#)", "", "100%"};
		{ 14, 18713, "", "=q4=Rhok'delar, Longbow of the Ancient Keepers", "=q1=#m4#: =ds=#w2#, =q1=#m1# =ds=#c2#"};
		{ 16, 16914, "", "=q4=Netherwind Crown", "=q1=#m1# =ds=#c3#", "", "14.09%"};
		{ 17, 16929, "", "=q4=Nemesis Skullcap", "=q1=#m1# =ds=#c8#", "", "13.54%"};
		{ 18, 16921, "", "=q4=Halo of Transcendence", "=q1=#m1# =ds=#c5#", "", "13.39%"};
		{ 19, 16908, "", "=q4=Bloodfang Hood", "=q1=#m1# =ds=#c6#", "", "13.21%"};
		{ 20, 16900, "", "=q4=Stormrage Cover", "=q1=#m1# =ds=#c1#", "", "13.08%"};
		{ 21, 16939, "", "=q4=Dragonstalker's Helm", "=q1=#m1# =ds=#c2#", "", "13.91%"};
		{ 22, 16947, "", "=q4=Helmet of Ten Storms", "=q1=#m1# =ds=#c7#", "", "4.86%"};
		{ 23, 16963, "", "=q4=Helm of Wrath", "=q1=#m1# =ds=#c9#", "", "13.65%"};
		{ 24, 16955, "", "=q4=Judgement Crown", "=q1=#m1# =ds=#c4#", "", "8.64%"};	
		{ 26, 18423, "", "=q4=Head of Onyxia", "=ds=#m3# =q1=", "", "41%"};
		{ 27, 18403, "", "=q4=Dragonslayer's Signet", "=ds=#s13#", "", "15.15%"};
		{ 28, 18406, "", "=q4=Onyxia Blood Talisman", "=ds=#s14#", "", "14.26%"};
		{ 29, 18404, "", "=q4=Onyxia Tooth Pendant", "=ds=#s2#", "", "14.33%"};
	};
	
		--------------------------------
		--- Onyxia's Lair L60 Heroic ---
		--------------------------------
		
		AtlasLoot_Data["OnyxiaL60HEROIC"] = {
		{ 1, 17078, "", "=q4=Sapphiron Drape", "=ds=#s4#", "", "14.95%"};
		{ 2, 18205, "", "=q4=Eshkandar's Collar", "=ds=#s2#", "", "14.33%"};
		{ 3, 18813, "", "=q4=Ring of Binding", "=ds=#s13#", "", "15.15%"};
		{ 4, 17064, "", "=q4=Shard of the Scale", "=ds=#s14#", "", "14.26%"};
		...
		{ 7, 17075, "", "=q4=Vis'kag th Bloodletter", "=ds=#h1#, #w10#", "", "6.98%"};
		{ 9, 31102, "", "=q4=Token of the Forgotten Vanquisher", "=ds=Tier 2 Token", "", "100%"};
		{ 10, 12325, "", "=q4=Reins of the Frenzied Chimera", "=ds=#e12#", "", ""};
		{ 13, 18705, "", "=q4=Mature Black Dragon Sinew", "=ds=#m3# =q1=(#c2#)", "", "100%"};
		{ 14, 18713, "", "=q4=Rhok'delar, Longbow of the Ancient Keepers", "=q1=#m4#: =ds=#w2#, =q1=#m1# =ds=#c2#"};
		{ 16, 16914, "", "=q4=Netherwind Crown", "=q1=#m1# =ds=#c3#", "", "14.09%"};
		{ 17, 16929, "", "=q4=Nemesis Skullcap", "=q1=#m1# =ds=#c8#", "", "13.54%"};
	...
	AtlasLoot_Data["RagefireChasm"] = {
		...
		-----------------------------
		--- Ragefire Chasm Mythic ---
		-----------------------------
		
--[[	AtlasLoot_Data["RagefireChasmMYTHIC"] = {
		{ 2, 0, "INV_Box_01", "=q6=Chest of the Conqueror", "#j55#"};
		{ 3, 56861, "", "=q4=Rune-Etched Dagger", "=ds=#h1#, #w4#", "", ""};
		{ 4, 56867, "", "=q4=Two-Ton Hammer", "=ds=#h2#, #w6#", "", ""};
		{ 5, 56874, "", "=q4=Last Resolve", "=ds=#s13#","",""};
		{ 6, 56872, "", "=q4=Wildcat Signet", "=ds=#s13#","",""};
		{ 7, 56875, "", "=q4=Whale Insignia", "=ds=#s14#","",""};
		{ 8, 56883, "", "=q4=Void Totem", "=ds=#w15#","",""};
		{ 17, 0, "INV_Box_01", "=q6=Chest of the Conqueror", "#j56#"};
		{ 18, 56999, "", "=q4=Rune-Etched Dagger (S2)", "=ds=#h1#, #w4#", "", ""};
		{ 19, 56996, "", "=q4=Two-Ton Hammer (S2)", "=ds=#h2#, #w6#", "", ""};
		{ 20, 56990, "", "=q4=Last Resolve (S2)", "=ds=#s13#","",""};
		{ 21, 56991, "", "=q4=Wildcat Signet (S2)", "=ds=#s13#","",""};
		{ 22, 56989, "", "=q4=Whale Insignia (S2)", "=ds=#s14#","",""};
		{ 23, 56883, "", "=q4=Void Totem", "=ds=#w15#","",""};
	};--]]
	...
	AtlasLoot_Data["SMTrash"] = {
		...
		--------------------------------
		--- Scarlet Monastery Mythic ---
		--------------------------------
		
--[[	AtlasLoot_Data["SMCathedralMYTHIC"] = {
		{ 2, 0, "INV_Box_01", "=q6=Chest of the Conqueror", "#j55#"};
		{ 3, 56858, "", "=q4=Atonement Hammer", "=ds=#h1#, #w6#", "", ""};
		{ 4, 56808, "", "=q4=Robes of Evocation", "=ds=#a1#, #s5#", "", ""};
		{ 5, 45254, "", "=q4=Sigil of the Vengeful Heart", "=ds=#w21#","",""};
		{ 6, 56880, "", "=q4=Defiance Libram", "=ds=#w16#","",""};
		{ 17, 0, "INV_Box_01", "=q6=Chest of the Conqueror", "#j56#"};
		{ 18, 56997, "", "=q4=Atonement Hammer (S2)", "=ds=#h1#, #w6#", "", ""};
		{ 19, 56808, "", "=q4=Robes of Evocation", "=ds=#a1#, #s5#", "", ""};
		{ 20, 45254, "", "=q4=Sigil of the Vengeful Heart", "=ds=#w21#","",""};
		{ 21, 56880, "", "=q4=Defiance Libram", "=ds=#w16#","",""};
		Next = "SMGraveyardMYTHIC";
]]--	};
	
--[[	AtlasLoot_Data["SMGraveyardMYTHIC"] = {
		{ 2, 0, "INV_Box_01", "=q6=Chest of the Conqueror", "#j55#"};
		{ 3, 56814, "", "=q4=Greataxe of the Warrior", "=ds=#h2#, #w1#", "", ""};
		{ 4, 56878, "", "=q4=Idol of Massive Growth", "=ds=#w14#", "", ""};
		{ 5, 56871, "", "=q4=Dragonflight Band", "=ds=#s13#","",""};
		{ 6, 56879, "", "=q4=Valiance Libram", "=ds=#w16#","",""};
		{ 17, 0, "INV_Box_01", "=q6=Chest of the Conqueror", "#j56#"};
		{ 18, 57004, "", "=q4=Greataxe of the Warrior (S2)", "=ds=#h2#, #w1#", "", ""};
		{ 19, 56878, "", "=q4=Idol of Massive Growth", "=ds=#w14#", "", ""};
		{ 20, 56993, "", "=q4=Dragonflight Band(S2)", "=ds=#s13#","",""};
		{ 21, 56879, "", "=q4=Valiance Libram", "=ds=#w16#","",""};
		Next = "SMLibraryMYTHIC";
		Prev = "SMCathedralMYTHIC";
	};--]]
	
--[[	AtlasLoot_Data["SMLibraryMYTHIC"] = {
		{ 2, 0, "INV_Box_01", "=q6=Chest of the Conqueror", "#j55#"};
		{ 3, 56813, "", "=q4=Staff of the Explorer", "=ds=#w9#", "", ""};
		{ 4, 57032, "", "=q4=Stone Insignia", "=ds=#s14#", "", ""};
		{ 5, 56877, "", "=q4=The Crying Moon", "=ds=#w14#","",""};
		{ 6, 56882, "", "=q4=Chained Totem", "=ds=#w15#","",""};
		{ 17, 0, "INV_Box_01", "=q6=Chest of the Conqueror", "#j56#"};
		{ 18, 57005, "", "=q4=Staff of the Explorer (S2)", "=ds=#w9#", "", ""};
		{ 19, 57032, "", "=q4=Stone Insignia", "=ds=#s14#", "", ""};
		{ 20, 56877, "", "=q4=The Crying Moon", "=ds=#w14#","",""};
		{ 21, 56882, "", "=q4=Chained Totem", "=ds=#w15#","",""};
		Prev = "SMGraveyardMYTHIC";
	};--]]
...
--[[	AtlasLoot_Data["ShadowfangKeep1MYTHIC"] = {
		{ 2, 0, "INV_Box_01", "=q6=Chest of the Conqueror", "#j55#"};
		{ 3, 56859, "", "=q4=Mazthoril Shield", "=ds=#w8#", "", ""};
		{ 4, 56873, "", "=q4=Dragon's Demise", "=ds=#s13#", "", ""};
		{ 5, 56876, "", "=q4=Moon's Fury", "=ds=#w14#", "", ""};
		{ 17, 0, "INV_Box_01", "=q6=Chest of the Conqueror", "#j56#"};
		{ 18, 57002, "", "=q4=Mazthoril Shield (S2)", "=ds=#w8#", "", ""};
		{ 19, 56992, "", "=q4=Dragon's Demise", "=ds=#s13#", "", ""};
		{ 20, 56876, "", "=q4=Moon's Fury", "=ds=#w14#", "", ""};
	};]]--
...
--[[	AtlasLoot_Data["TheStockadeMYTHIC"] = {
		{ 2, 0, "INV_Box_01", "=q6=Chest of the Conqueror", "#j55#"};
		{ 3, 56864, "", "=q4=Lava Warhammer", "=ds=#h1#, #w6#", "", ""};
		{ 4, 56862, "", "=q4=Dragonfang Dagger", "=ds=#h1#, #w4#", "", ""};
		{ 5, 40714, "", "=q4=Sigil of the Unfaltering Knight", "=ds=#w21#", "", ""};
		{ 6, 56881, "", "=q4=Storm Sigil", "=ds=#w15#", "", ""};
		{ 17, 0, "INV_Box_01", "=q6=Chest of the Conqueror", "#j56#"};
		{ 18, 57003, "", "=q4=Lava Warhammer (S2)", "=ds=#h1#, #w6#", "", ""};
		{ 19, 57000, "", "=q4=Dragonfang Dagger (S2)", "=ds=#h1#, #w4#", "", ""};
		{ 20, 40714, "", "=q4=Sigil of the Unfaltering Knight", "=ds=#w21#", "", ""};
		{ 21, 56881, "", "=q4=Storm Sigil", "=ds=#w15#", "", ""};
	};]]--
...
--[[	AtlasLoot_Data["ZFAntusulMYTHIC"] = {
		{ 2, 0, "INV_Box_01", "=q6=Chest of the Conqueror", "#j55#"};
		{ 3, 56868, "", "=q4=The Bone Arbiter", "=ds=#h2#, #w1#", "", ""};
		{ 4, 56813, "", "=q4=Staff of the Explorer", "=ds=#w9#", "", ""};
		{ 5, 56860, "", "=q4=Jeweled Grimoire", "=ds=#h4#", "", ""};
		{ 6, 56882, "", "=q4=Chained Totem", "=ds=#w15#", "", ""};
		{ 17, 0, "INV_Box_01", "=q6=Chest of the Conqueror", "#j56#"};
		{ 18, 56995, "", "=q4=The Bone Arbiter (S2)", "=ds=#h2#, #w1#", "", ""};
		{ 19, 57005, "", "=q4=Staff of the Explorer (S2)", "=ds=#w9#", "", ""};
		{ 20, 56998, "", "=q4=Jeweled Grimoire (S2)", "=ds=#h4#", "", ""};
		{ 21, 56882, "", "=q4=Chained Totem", "=ds=#w15#", "", ""};
	};]]--
	...
	AtlasLoot_Data["ZGJeklikHEROIC"] = {
		{ 1, 57123, "", "=q4=Jeklik's Crusher", "=ds=#h2#, #w6#", "", "100%"};
		{ 2, 57124, "", "=q3=Jeklik's Opaline Talisman", "=ds=#s2#", "", "100%"};
		{ 3, 57125, "", "=q3=Primalist's Band", "=ds=#s13#", "", "100%"};
		{ 4, 57127, "", "=q3=Zulian Defender", "=ds=#w8#", "", " 100%"};
		Next = "ZGVenoxisHEROIC";
	};

	AtlasLoot_Data["ZGVenoxisHEROIC"] = {
		{ 1, 57128, "", "=q4=Fang of Venoxis", "=ds=#h3#, #w4#", "", "100%"};
		{ 2, 57129, "", "=q3=Zanzil's Band", "=ds=#s13#", "", "100%"};
		{ 3, 57131, "", "=q3=Zulian Stone Axe", "=ds=#h2#, #w1#", "", "100%"};
		Next = "ZGMarliHEROIC";
		Prev = "ZGJeklikHEROIC";
	};

	AtlasLoot_Data["ZGMarliHEROIC"] = {
		{ 1, 57132, "", "=q4=Mar'li's Touch", "=ds=#w12#", "", "100%"};
		{ 2, 57133, "", "=q3=Talisman of Protection", "=ds=#s2#", "", "100%"};
		{ 3, 57134, "", "=q3=Band of Jin", "=ds=#s13#", "", "100%"};
		{ 4, 57136, "", "=q3=Mar'li's Eye", "=ds=#s14#", "", "100%"};
		Next = "ZGMandokirHEROIC";
		Prev = "ZGVenoxisHEROIC";
	};

	AtlasLoot_Data["ZGMandokirHEROIC"] = {
		{ 1, 57126, "", "=q3=Primalist's Seal", "=ds=#s13#", "", "100%"};
		{ 2, 57130, "", "=q3=Zanzil's Seal", "=ds=#s13#", "", "100%"};
		{ 3, 57137, "", "=q4=Bloodlord's Defender", "=ds=#h1#, #w10#", "", "100%"};
		{ 4, 57138, "", "=q4=Warblade of the Hakkari", "=ds=#h4#, #w10#", "", "100%"};
		{ 5, 57140, "", "=q4=Halberd of Smiting", "=ds=#w7#", "", "100%"};
		{ 6, 57141, "", "=q4=Mandokir's Sting", "=ds=#w2#", "", "100%"};
		{ 7, 57142, "", "=q3=Overlord's Crimson Band", "=ds=#s13#", "", "100%"};
		Next = "ZGThekalHEROIC";
		Prev = "ZGMarliHEROIC";
	};

	AtlasLoot_Data["ZGThekalHEROIC"] = {
		{ 1, 57135, "", "=q3=Seal of Jin", "=ds=#s13#", "", "100%"};
		{ 2, 57144, "", "=q4=Thekal's Grasp", "=ds=#h3#, #w13#", "", "4.23%"};
		{ 3, 57137, "", "=q3=Zulian Slicer", "=ds=#h1#, #w10#, =q1=#e18#", "", "100%"};
		{ 4, 57146, "", "=q3=Zulian Slicer", "=ds=#h1#, #w10#, =q1=#e18#", "", "13.36%"};
		Next = "ZGArlokkHEROIC";
		Prev = "ZGMandokirHEROIC";
	};

	AtlasLoot_Data["ZGArlokkHEROIC"] = {
		{ 1, 57143, "", "=q3=Overlord's Onyx Band", "=ds=#s13#", "", "100%"};
		{ 2, 57145, "", "=q4=Arlokk's Grasp", "=ds=#h4#, #w13#", "", "100%"};
		{ 3, 57147, "", "=q4=Will of Arlokk", "=ds=#w9#", "", "100%"};
		{ 4, 57148, "", "=q3=Arlokk's Hoodoo Stick", "=ds=#s15#", "", "100%"};
		Next = "ZGJindoHEROIC";
		Prev = "ZGThekalHEROIC";
	};

	AtlasLoot_Data["ZGJindoHEROIC"] = {
		{ 1, 57149, "", "=q4=Jin'do's Evil Eye", "=ds=#s2#", "", "100%"};
		{ 2, 57150, "", "=q4=Jin'do's Bag of Whammies", "=ds=#s15#", "", "100%"};
		{ 3, 57151, "", "=q4=Jin'do's Hexxer", "=ds=#h3#, #w6#", "", "100%"};
		{ 4, 57152, "", "=q4=Jin'do's Judgement", "=ds=#w9#", "", "100%"};
		Next = "ZGHakkarHEROIC";
		Prev = "ZGArlokkHEROIC";
	};

	AtlasLoot_Data["ZGHakkarHEROIC"] = {
		{ 1, 57139, "", "=q4=Warblade of the Hakkari", "=ds=#h3#, #w10#", "", "100%"};
		{ 2, 57153, "", "=q4=Soul Corrupter's Necklace", "=ds=#s2#", "", "100%"};
		{ 3, 57154, "", "=q4=The Eye of Hakkar", "=ds=#s2#", "", "100%"};
		{ 4, 57155, "", "=q4=Fang of the Faceless", "=ds=#h1#, #w4#", "", "100%"};
		{ 5, 57156, "", "=q4=Bloodcaller", "=ds=#h3#, #w10#", "", "100%"};
		{ 6, 57157, "", "=q4=Zin'rokh, Destroyer of Worlds", "=ds=#h2#, #w10#", "", "100%"};
		{ 7, 57158, "", "=q4=Touch of Chaos", "=ds=#w12#", "", "100%"};
		{ 8, 57159, "", "=q4=Gurubashi Dwarf Destroyer", "=ds=#w5#", "", "100%"};
		Prev = "ZGJindoHEROIC";
	};
	...
	AtlasLoot_Data["T0Warrior"] = {
		...
		AtlasLoot_Data["+2"] = {
		{ 1, 56868, "", "=q4=The Bone Arbiter", "=ds=#h2#, #w1#", "", ""};
		{ 2, 56814, "", "=q4=Greataxe of the Warrior", "=ds=#h2#, #w1#", "", ""};
		{ 3, 56867, "", "=q4=Two-Ton Hammer", "=ds=#h2#, #w6#", "", ""};
		{ 4, 56813, "", "=q4=Staff of the Explorer", "=ds=#w9#", "", ""};
		{ 5, 56864, "", "=q4=Lava Warhammer", "=ds=#h1#, #w6#", "", ""};
		{ 6, 56858, "", "=q4=Atonement Hammer", "=ds=#h1#, #w6#", "", ""};
		{ 7, 56869, "", "=q4=Bane Broadsword", "=ds=#h1#, #w10#", "", ""};
		{ 8, 56812, "", "=q4=Cursed Felblade", "=ds=#h1#, #w10#", "", ""};
		{ 9, 56862, "", "=q4=Dragonfang Dagger", "=ds=#h1#, #w4#", "", ""};
		{ 10, 56861, "", "=q4=Rune-Etched Dagger", "=ds=#h1#, #w4#", "", ""};
		{ 11, 56863, "", "=q4=Twine-Covered Bow", "=ds=#w2#", "", ""};
		{ 12, 56859, "", "=q4=Mazthoril Shield", "=ds=#w8#", "", ""};
		{ 13, 56815, "", "=q4=Magma Shield", "=ds=#w8#", "", ""};
		{ 14, 56860, "", "=q4=Jeweled Grimoire", "=ds=#h4#", "", ""};
		
		{ 16, 56873, "", "=q4=Dragon's Demise", "=ds=#s13#", "", ""};
		{ 17, 56871, "", "=q4=Dragonflight Band", "=ds=#s13#","",""};	
		{ 18, 56874, "", "=q4=Last Resolve", "=ds=#s13#","",""};
		{ 19, 56872, "", "=q4=Wildcat Signet", "=ds=#s13#","",""};
		{ 20, 57789, "", "=q4=Blood Sun Necklace", "=ds=#s2#", "", ""};
		{ 21, 57792, "", "=q4=Bulwark Necklace", "=ds=#s2#", "", ""};
		{ 22, 57795, "", "=q4=Dragonflight Necklace", "=ds=#s2#", "", ""};
		{ 23, 57032, "", "=q4=Stone Insignia", "=ds=#s14#", "", ""};	
		{ 24, 56875, "", "=q4=Whale Insignia", "=ds=#s14#","",""};
		--[[{ 16, 56882, "", "=q4=Chained Totem", "=ds=#w15#", "", ""};
		{ 17, 56881, "", "=q4=Storm Sigil", "=ds=#w15#", "", ""};
		{ 18, 56883, "", "=q4=Void Totem", "=ds=#w15#","",""};
		{ 19, 56876, "", "=q4=Moon's Fury", "=ds=#w14#", "", ""};
		{ 20, 56877, "", "=q4=The Crying Moon", "=ds=#w14#","",""};
		{ 21, 56878, "", "=q4=Idol of Massive Growth", "=ds=#w14#", "", ""};
		{ 22, 40714, "", "=q4=Sigil of the Unfaltering Knight", "=ds=#w21#", "", ""};
		{ 23, 45254, "", "=q4=Sigil of the Vengeful Heart", "=ds=#w21#","",""};
		{ 24, 56879, "", "=q4=Valiance Libram", "=ds=#w16#","",""};
		{ 25, 56880, "", "=q4=Defiance Libram", "=ds=#w16#","",""};
		{ 27, 56808, "", "=q4=Robes of Evocation", "=ds=#a1#, #s5#", "", ""};
		{ 28, 56807, "", "=q4=Crystalline Cuffs", "=ds=#s8#, #a1#", "", ""};	]]--	
	...
	AtlasLoot_Data["+4"] = {
		{ 1, 57748, "", "=q4=The Bone Arbiter +4", "=ds=#h2#, #w1#", "", ""};
		{ 2, 57750, "", "=q4=Greataxe of the Warrior +4", "=ds=#h2#, #w1#", "", ""};
		{ 3, 57752, "", "=q4=Two-Ton Hammer +4", "=ds=#h2#, #w6#", "", ""};
		{ 4, 57754, "", "=q4=Staff of the Explorer +4", "=ds=#w9#", "", ""};
		{ 5, 57756, "", "=q4=Lava Warhammer +4", "=ds=#h1#, #w6#", "", ""};
		{ 6, 57758, "", "=q4=Atonement Hammer +4", "=ds=#h1#, #w6#", "", ""};
		{ 7, 57760, "", "=q4=Bane Broadsword +4", "=ds=#h1#, #w10#", "", ""};
		{ 8, 57762, "", "=q4=Cursed Felblade +4", "=ds=#h1#, #w10#", "", ""};
		{ 9, 57765, "", "=q4=Dragonfang Dagger +4", "=ds=#h1#, #w4#", "", ""};
		{ 10, 57767, "", "=q4=Rune-Etched Dagger +4", "=ds=#h1#, #w4#", "", ""};
		{ 11, 57769, "", "=q4=Twine-Covered Bow +4", "=ds=#w2#", "", ""};
		{ 12, 57771, "", "=q4=Mazthoril Shield +4", "=ds=#w8#", "", ""};
		{ 13, 57773, "", "=q4=Magma Shield +4", "=ds=#w8#", "", ""};
		{ 14, 57775, "", "=q4=Jeweled Grimoire +4", "=ds=#h4#", "", ""};
		
		{ 16, 57777, "", "=q4=Dragon's Demise +4", "=ds=#s13#", "", ""};
		{ 17, 57779, "", "=q4=Dragonflight Band +4", "=ds=#s13#","",""};	
		{ 18, 57781, "", "=q4=Last Resolve +4", "=ds=#s13#","",""};
		{ 19, 57783, "", "=q4=Wildcat Signet +4", "=ds=#s13#","",""};
		{ 20, 57790, "", "=q4=Blood Sun Necklace +4", "=ds=#s2#", "", ""};
		{ 21, 57793, "", "=q4=Bulwark Necklace +4", "=ds=#s2#", "", ""};
		{ 22, 57796, "", "=q4=Dragonflight Necklace +4", "=ds=#s2#", "", ""};
		{ 23, 57785, "", "=q4=Stone Insignia +4", "=ds=#s14#", "", ""};	
		{ 24, 57787, "", "=q4=Whale Insignia +4", "=ds=#s14#","",""};	
	...
	AtlasLoot_Data["+6"] = {
		{ 1, 57749, "", "=q4=The Bone Arbiter +6", "=ds=#h2#, #w1#", "", ""};
		{ 2, 57751, "", "=q4=Greataxe of the Warrior +6", "=ds=#h2#, #w1#", "", ""};
		{ 3, 57753, "", "=q4=Two-Ton Hammer +6", "=ds=#h2#, #w6#", "", ""};
		{ 4, 57755, "", "=q4=Staff of the Explorer +6", "=ds=#w9#", "", ""};
		{ 5, 57757, "", "=q4=Lava Warhammer +6", "=ds=#h1#, #w6#", "", ""};
		{ 6, 57759, "", "=q4=Atonement Hammer +6", "=ds=#h1#, #w6#", "", ""};
		{ 7, 57761, "", "=q4=Bane Broadsword +6", "=ds=#h1#, #w10#", "", ""};
		{ 8, 57763, "", "=q4=Cursed Felblade +6", "=ds=#h1#, #w10#", "", ""};
		{ 9, 57766, "", "=q4=Dragonfang Dagger +6", "=ds=#h1#, #w4#", "", ""};
		{ 10, 57768, "", "=q4=Rune-Etched Dagger +6", "=ds=#h1#, #w4#", "", ""};
		{ 11, 57770, "", "=q4=Twine-Covered Bow +6", "=ds=#w2#", "", ""};
		{ 12, 57772, "", "=q4=Mazthoril Shield +6", "=ds=#w8#", "", ""};
		{ 13, 57774, "", "=q4=Magma Shield +6", "=ds=#w8#", "", ""};
		{ 14, 57776, "", "=q4=Jeweled Grimoire +6", "=ds=#h4#", "", ""};
		
		{ 16, 57778, "", "=q4=Dragon's Demise +6", "=ds=#s13#", "", ""};
		{ 17, 57780, "", "=q4=Dragonflight Band +6", "=ds=#s13#","",""};	
		{ 18, 57782, "", "=q4=Last Resolve +6", "=ds=#s13#","",""};
		{ 19, 57784, "", "=q4=Wildcat Signet +6", "=ds=#s13#","",""};
		{ 20, 57791, "", "=q4=Blood Sun Necklace +6", "=ds=#s2#", "", ""};
		{ 21, 57794, "", "=q4=Bulwark Necklace +6", "=ds=#s2#", "", ""};
		{ 22, 57797, "", "=q4=Dragonflight Necklace +6", "=ds=#s2#", "", ""};
		{ 23, 57786, "", "=q4=Stone Insignia +6", "=ds=#s14#", "", ""};	
		{ 24, 57788, "", "=q4=Whale Insignia +6", "=ds=#s14#","",""};
	...
	AtlasLoot_Data["+8"] = {
		{ 1, 56995, "", "=q4=The Bone Arbiter (S2)", "=ds=#h2#, #w1#", "", ""};
		{ 2, 57004, "", "=q4=Greataxe of the Warrior (S2)", "=ds=#h2#, #w1#", "", ""};
		{ 3, 56996, "", "=q4=Two-Ton Hammer (S2)", "=ds=#h2#, #w6#", "", ""};
		{ 4, 57005, "", "=q4=Staff of the Explorer (S2)", "=ds=#w9#", "", ""};
		{ 5, 57001, "", "=q4=Twine-Covered Bow (S2)", "=ds=#w2#", "", ""};
		{ 6, 57003, "", "=q4=Lava Warhammer (S2)", "=ds=#h1#, #w6#", "", ""};
		{ 7, 56997, "", "=q4=Atonement Hammer (S2)", "=ds=#h1#, #w6#", "", ""};
		{ 8, 56994, "", "=q4=Bane Broadsword (S2)", "=ds=#h1#, #w10#", "", ""};
--		{ 9, 56812, "", "=q4=Cursed Felblade (S2)", "=ds=#h1#, #w10#", "", ""};
		{ 9, 57000, "", "=q4=Dragonfang Dagger (S2)", "=ds=#h1#, #w4#", "", ""};
		{ 10, 56999, "", "=q4=Rune-Etched Dagger (S2)", "=ds=#h1#, #w4#", "", ""};
		{ 11, 57002, "", "=q4=Mazthoril Shield (S2)", "=ds=#w8#", "", ""};
		{ 12, 57012, "", "=q4=Magma Shield (S2)", "=ds=#w8#", "", ""};
		{ 13, 56998, "", "=q4=Jeweled Grimoire (S2)", "=ds=#h4#", "", ""};

		{ 16, 56992, "", "=q4=Dragon's Demise (S2)", "=ds=#s13#", "", ""};
		{ 17, 56993, "", "=q4=Dragonflight Band (S2)", "=ds=#s13#", "", ""};	
		{ 18, 56990, "", "=q4=Last Resolve (S2)", "=ds=#s13#", "", ""};
		{ 19, 56991, "", "=q4=Wildcat Signet (S2)", "=ds=#s13#", "", ""};
		{ 20, 57030, "", "=q4=Blood Sun Necklace", "=ds=#s2#", "", ""};
		{ 21, 57031, "", "=q4=Bulwark Necklace", "=ds=#s2#", "", ""};
		{ 22, 57029, "", "=q4=Dragonflight Necklace", "=ds=#s2#", "", ""};
		{ 23, 57079, "", "=q4=Stone Insignia (S2)", "=ds=#s14#", "", ""};	
		{ 24, 56989, "", "=q4=Whale Insignia (S2)", "=ds=#s14#", "", ""};

		{ 27, 0, "INV_Box_01", "Any S2 set item", "Check Mythic Dungeon Sets", "", ""};
		
		Prev = "+6";
		Back = "MYTHICMENU";
	};
	
	AtlasLoot_Data["KeystoneChallenge"] = {
		{1, 57620, "", "=q4=Mojo Masked Crusher", "=ds=#h2#, #w6# ", "", ""};
		{2, 57610, "", "=q4=Enraged Feral Staff", "=ds=#w9# ", "", ""};
		{3, 57613, "", "=q4=Staff of Wayward Principles", "=ds=#w9# ", "", ""};
		{4, 57612, "", "=q4=Drake-Mounted Crossbow", "=ds=#w3# ", "", ""};
		{5, 57686, "", "=q4=War Mace of Unrequited Love", "=ds=#h3#, #w6# ", "", ""};
		{6, 57608, "", "=q4=Crypt Lord's Deft Blade", "=ds=#h1#, #w10# ", "", ""};
		{7, 57614, "", "=q4=Red Sword of Courage", "=ds=#h1#, #w10# ", "", ""};
		{8, 57609, "", "=q4=Dagger of Betrayal", "=ds=#h1#, #w4# ", "", ""};
		{9, 57684, "", "=q4=Titansteel Spellblade", "=ds=#h3#, #w4# ", "", ""};
		{10, 57685, "", "=q4=Bulwark of the Noble Protector", "=ds=#w8# ", "", ""};
		{11, 57607, "", "=q4=Stained-Glass Shard Ring", "=ds=#s13# ", "", ""};
		{12, 57605, "", "=q4=Ring of the Traitor King", "=ds=#s13# ", "", ""};
		{13, 57683, "", "=q4=Band of Guile", "=ds=#s13# ", "", ""};
		{14, 57611, "", "=q4=Unsmashable Heavy Band", "=ds=#s13# ", "", ""};
		{15, 57618, "", "=q4=Keystone Great-Ring", "=ds=#s13# ", "", ""};
		{16, 57615, "", "=q4=Gold Amulet of Kings", "=ds=#s2# ", "", ""};
		{17, 57616, "", "=q4=Meteorite Whetstone", "=ds=#s14# ", "", ""};
		{18, 57617, "", "=q4=Incisor Fragment", "=ds=#s14# ", "", ""};
		{19, 57682, "", "=q4=Mark of the War Prisoner", "=ds=#s14# ", "", ""};
		{20, 57606, "", "=q4=Essence of Gossamer", "=ds=#s14# ", "", ""};
		{21, 57681, "", "=q4=Spark of Life", "=ds=#s14# ", "", ""};
		{22, 57619, "", "=q4=Talisman of Troll Divination", "=ds=#s14# ", "", ""};
		...
		AtlasLoot_Data["MythicMoonglade"] = {
		{ 1, 0, "spell_arcane_teleportmoonglade", "=q6=#ds3s6#", "=ec1=#j55#"};
		{ 2, 56843, "", "=q4=Moonglade Headpiece", "=ds=#s1#, #a2#"};
		{ 3, 56844, "", "=q4=Moonglade Shoulderpads", "=ds=#s3#, #a2#"};
		{ 4, 56845, "", "=q4=Moonglade Robes", "=ds=#s5#, #a2#"};
		...
		AtlasLoot_Data["MythicBluefang"] = {
		{ 1, 0, "ability_rogue_masterofsubtlety", "=q6=Bluefang Armor", "=ec1=#j55#"};
		{ 2, 56818, "", "=q4=Bluefang Hood", "=ds=#s1#, #a2#"};
		{ 3, 56817, "", "=q4=Bluefang Spaulders", "=ds=#s3#, #a2#"};
		{ 4, 56819, "", "=q4=Bluefang Chestpiece", "=ds=#s5#, #a2#"};
		...
		AtlasLoot_Data["MythicDragonsteel"] = {
		{ 1, 0, "spell_deathknight_frostpresence", "=q6=Dragonsteel Plate", "=ec1=#j55#"};
		{ 2, 57045, "", "=q4=Dragonsteel Faceguard", "=ds=#s1#, #a4#"};
		{ 3, 57046, "", "=q4=Dragonsteel Spaulders", "=ds=#s3#, #a4#"};
		{ 4, 57047, "", "=q4=Dragonsteel Chestguard", "=ds=#s5#, #a4#"};
		{ 5, 57048, "", "=q4=Dragonsteel Leggings", "=ds=#s11#, #a4#"};
		{ 6, 57049, "", "=q4=Dragonsteel Gauntlets", "=ds=#s9#, #a4#"};
		--[[{ 16, 0, "spell_deathknight_frostpresence", "=q6=Dragonsteel Plate", "=ec1=#j56#"};
		{ 17, 57045, "", "=q4=Dragonsteel Faceguard", "=ds=#s1#, #a4#"};
		{ 18, 57046, "", "=q4=Dragonsteel Spaulders", "=ds=#s3#, #a4#"};
		{ 19, 57047, "", "=q4=Dragonsteel Chestguard", "=ds=#s5#, #a4#"};
		{ 20, 57048, "", "=q4=Dragonsteel Leggings", "=ds=#s11#, #a4#"};
		{ 21, 57049, "", "=q4=Dragonsteel Gauntlets", "=ds=#s9#, #a4#"};]]--
		Back = "MYTHICSET";
		}
		
		AtlasLoot_Data["MythicPenance"] = {
		{ 1, 0, "Ability_Warrior_BattleShout", "=q6=Penance Battlegear", "=ec1=#j55#"};
		{ 2, 56822, "", "=q4=Mask of Penance", "=ds=#s1#, #a4#"};
		{ 3, 56823, "", "=q4=Shoulderplates of Penance", "=ds=#s3#, #a4#"};
		{ 4, 56824, "", "=q4=Breastplate of Penance", "=ds=#s5#, #a4#"};
		...
		AtlasLoot_Data["MythicRuby"] = {
		{ 1, 0, "ability_warrior_shieldwall", "=q6=Ruby Plate", "=ec1=#j55#"};
		{ 2, 56837, "", "=q4=Ruby Helm", "=ds=#s1#, #a4#"};
		{ 3, 56838, "", "=q4=Ruby Spaulders", "=ds=#s3#, #a4#"};
		{ 4, 56839, "", "=q4=Ruby Chestguard", "=ds=#s5#, #a4#"};
		...
		AtlasLoot_Data["MythicDemonfang"] = {
		{ 1, 0, "Spell_Frost_IceStorm", "=q6=Demonfang Regalia", "=ec1=#j55#"};
		{ 2, 56827, "", "=q4=Demonfang Mask", "=ds=#s1#, #a1#"};
		{ 3, 56828, "", "=q4=Demonfang Spaulders", "=ds=#s3#, #a1#"};
		{ 4, 56829, "", "=q4=Demonfang Robe", "=ds=#s5#, #a1#"};
		...
		AtlasLoot_Data["MythicTidefury"] = {
		{ 1, 0, "Spell_FireResistanceTotem_01", "=q6=Tidefury Raiment", "=ec1=#j55#"};
		{ 2, 56848, "", "=q4=Tidefury Helmet", "=ds=#s1#, #a3#"};
		{ 3, 56849, "", "=q4=Tidefury Shoulderpads", "=ds=#s3#, #a3#"};
		{ 4, 56850, "", "=q4=Tidefury Chestpiece", "=ds=#s5#, #a3#"};
		...
		AtlasLoot_Data["MythicDreamwing"] = {
		{ 1, 0, "inv_spear_02", "=q6=Dreamwing Armor", "=ec1=#j55#"};
		{ 2, 56832, "", "=q4=Dreamwing Helmet", "=ds=#s1#, #a3#"};
		{ 3, 56833, "", "=q4=Dreamwing Pauldrons", "=ds=#s3#, #a3#"};
		{ 4, 56834, "", "=q4=Dreamwing Chestpiece", "=ds=#s5#, #a3#"};
		...
		AtlasLoot_Data["MythicGrace"] = {
		{ 1, 0, "Spell_Holy_PowerWordShield", "=q6=Vestments of Inner Grace", "=ec1=#j55#"};
		{ 2, 57041, "", "=q4=Headdress of Inner Grace", "=ds=#s1#, #a1#"};
		{ 3, 57040, "", "=q4=Pauldrons of Inner Grace", "=ds=#s3#, #a1#"};
		{ 4, 57043, "", "=q4=Robe of Inner Grace", "=ds=#s5#, #a1#"};
		{ 5, 57042, "", "=q4=Pantaloons of Inner Grace", "=ds=#s11#, #a1#"};
		{ 6, 57044, "", "=q4=Gloves of Inner Grace", "=ds=#s9#, #a1#"};
		--[[{ 16, 0, "Spell_Holy_PowerWordShield", "=q6=Vestments of Inner Grace", "=ec1=#j56#"};
		{ 17, 57041, "", "=q4=Headdress of Inner Grace", "=ds=#s1#, #a1#"};
		{ 18, 57040, "", "=q4=Pauldrons of Inner Grace", "=ds=#s3#, #a1#"};
		{ 19, 57043, "", "=q4=Robe of Inner Grace", "=ds=#s5#, #a1#"};
		{ 20, 57042, "", "=q4=Pantaloons of Inner Grace", "=ds=#s11#, #a1#"};
		{ 21, 57044, "", "=q4=Gloves of Inner Grace", "=ds=#s9#, #a1#"};]]--
		Back = "MYTHICSET";
		}

		AtlasLoot_Data["MythicBold"] = {
		{ 1, 0, "spell_holy_holybolt", "=q6=Bold Armor", "=ec1=#j55#"};
		{ 2, 56853, "", "=q4=Helm of the Bold", "=ds=#s1#, #a4#"};
		{ 3, 56854, "", "=q4=Spaulders of the Bold", "=ds=#s3#, #a4#"};
		{ 4, 56855, "", "=q4=Chestguard of the Bold", "=ds=#s5#, #a4#"};
	...
	AtlasLoot_Data["T1Warrior"]= {
		...
		{ 16, 0, "INV_Shield_05", "=q6=#t1s9#", "=ec1=#m30#"};
		{ 17, 54883, "", "=q4=Helm of Might (DPS)", "=ds="..BabbleBoss["Garr"].."", "", "11.39%"};
		{ 18, 54884, "", "=q4=Pauldrons of Might (DPS)", "=ds="..BabbleBoss["Sulfuron Harbinger"].."", "", "21.14%"};
		{ 19, 54885, "", "=q4=Breastplate of Might (DPS)", "=ds="..BabbleBoss["Golemagg the Incinerator"].."", "", "15.28%"};
		{ 20, 54886, "", "=q4=Bracers of Might (DPS)", "=ds="..AL["Trash Mobs"].."", "", "0.16%"};
		{ 21, 54887, "", "=q4=Gauntlets of Might (DPS)", "=ds="..BabbleBoss["Lucifron"].."", "", "16.40%"};
		{ 22, 54888, "", "=q4=Belt of Might (DPS)", "=ds="..AL["Trash Mobs"].."", "", "0.16%"};
		{ 23, 54889, "", "=q4=Legplates of Might (DPS)", "=ds="..BabbleBoss["Magmadar"].."", "", "13.97%"};
		{ 24, 54890, "", "=q4=Sabatons of Might (DPS)", "=ds="..BabbleBoss["Gehennas"].."", "", "14.48%"};
		Back="T1SET";
	};
	AtlasLoot_Data["T1DkDamage"]={
		{ 1, 54883, "", "=q4=Helm of Might (DPS)", "=ds="..BabbleBoss["Garr"].."", "", "11.39%"};
		{ 2, 54884, "", "=q4=Pauldrons of Might (DPS)", "=ds="..BabbleBoss["Sulfuron Harbinger"].."", "", "21.14%"};
		{ 3, 54885, "", "=q4=Breastplate of Might (DPS)", "=ds="..BabbleBoss["Golemagg the Incinerator"].."", "", "15.28%"};
		{ 4, 54886, "", "=q4=Bracers of Might (DPS)", "=ds="..AL["Trash Mobs"].."", "", "0.16%"};
		{ 5, 54887, "", "=q4=Gauntlets of Might (DPS)", "=ds="..BabbleBoss["Lucifron"].."", "", "16.40%"};
		{ 6, 54888, "", "=q4=Belt of Might (DPS)", "=ds="..AL["Trash Mobs"].."", "", "0.16%"};
		{ 7, 54889, "", "=q4=Legplates of Might (DPS)", "=ds="..BabbleBoss["Magmadar"].."", "", "13.97%"};
		{ 8, 54890, "", "=q4=Sabatons of Might (DPS)", "=ds="..BabbleBoss["Gehennas"].."", "", "14.48%"};
		Back="T1Dk";
	};
	AtlasLoot_Data["T1PaladinHoly"]= {
		{ 1, 54915, "", "=q4=Lawbringer Helm (Holy)", "=ds="..BabbleBoss["Garr"].."", "", "7.23%"};
		{ 2, 54916, "", "=q4=Lawbringer Spaulders (Holy)", "=ds="..BabbleBoss["Baron Geddon"].."", "", "12.62%"};
		{ 3, 54917, "", "=q4=Lawbringer Chestguard (Holy)", "=ds="..BabbleBoss["Golemagg the Incinerator"].."", "", "9.53%"};
		{ 4, 54918, "", "=q4=Lawbringer Bracers (Holy)", "=ds="..AL["Trash Mobs"].."", "", "0.11%"};
		{ 5, 54919, "", "=q4=Lawbringer Gauntlets (Holy)", "=ds="..BabbleBoss["Gehennas"].."", "", "11.77%"};
		{ 6, 54920, "", "=q4=Lawbringer Belt (Holy)", "=ds="..AL["Trash Mobs"].."", "", "0.10%"};
		{ 7, 54921, "", "=q4=Lawbringer Legplates (Holy)", "=ds="..BabbleBoss["Magmadar"].."", "", "8.54%"};
		{ 8, 54922, "", "=q4=Lawbringer Boots (Holy)", "=ds="..BabbleBoss["Lucifron"].."", "", "7.20%"};
		Back="T1Paladin";
	};
	AtlasLoot_Data["T1PaladinProtection"]={
		{ 1, 54907, "", "=q4=Lawbringer Helm (Protection)", "=ds="..BabbleBoss["Garr"].."", "", "7.23%"};
		{ 2, 54908, "", "=q4=Lawbringer Spaulders (Protection)", "=ds="..BabbleBoss["Baron Geddon"].."", "", "12.62%"};
		{ 3, 54909, "", "=q4=Lawbringer Chestguard (Protection)", "=ds="..BabbleBoss["Golemagg the Incinerator"].."", "", "9.53%"};
		{ 4, 54910, "", "=q4=Lawbringer Bracers (Protection)", "=ds="..AL["Trash Mobs"].."", "", "0.11%"};
		{ 5, 54911, "", "=q4=Lawbringer Gauntlets (Protection)", "=ds="..BabbleBoss["Gehennas"].."", "", "11.77%"};
		{ 6, 54912, "", "=q4=Lawbringer Belt (Protection)", "=ds="..AL["Trash Mobs"].."", "", "0.10%"};
		{ 7, 54913, "", "=q4=Lawbringer Legplates (Protection)", "=ds="..BabbleBoss["Magmadar"].."", "", "8.54%"};
		{ 8, 54914, "", "=q4=Lawbringer Boots (Protection)", "=ds="..BabbleBoss["Lucifron"].."", "", "7.20%"};
		Back="T1Paladin";
	};
	AtlasLoot_Data["T1PaladinRetribution"]={
		{ 1, 0, "Spell_Holy_SealOfMight", "=q6=#t1s4#", "=ec1=#m30#"};
		{ 2, 54923, "", "=q4=Lawbringer Helm (Retribution)", "=ds="..BabbleBoss["Garr"].."", "", "7.23%"};
		{ 3, 54924, "", "=q4=Lawbringer Spaulders (Retribution)", "=ds="..BabbleBoss["Baron Geddon"].."", "", "12.62%"};
		{ 4, 54925, "", "=q4=Lawbringer Chestguard (Retribution)", "=ds="..BabbleBoss["Golemagg the Incinerator"].."", "", "9.53%"};
		{ 5, 54926, "", "=q4=Lawbringer Bracers (Retribution)", "=ds="..AL["Trash Mobs"].."", "", "0.11%"};
		{ 6, 54927, "", "=q4=Lawbringer Gauntlets (Retribution)", "=ds="..BabbleBoss["Gehennas"].."", "", "11.77%"};
		{ 7, 54928, "", "=q4=Lawbringer Belt (Retribution)", "=ds="..AL["Trash Mobs"].."", "", "0.10%"};
		{ 8, 54929, "", "=q4=Lawbringer Legplates (Retribution)", "=ds="..BabbleBoss["Magmadar"].."", "", "8.54%"};
		{ 9, 54930, "", "=q4=Lawbringer Boots (Retribution)", "=ds="..BabbleBoss["Lucifron"].."", "", "7.20%"};
		Back="T1Paladin";
	};
	...
	AtlasLoot_Data["T1PriestShadow"]={
		{ 17, 54931, "", "=q4=Circlet of Prophecy (Shadow)", "=ds="..BabbleBoss["Garr"].."", "", "11.36%"};
		{ 18, 54932, "", "=q4=Mantle of Prophecy (Shadow)", "=ds="..BabbleBoss["Sulfuron Harbinger"].."", "", "21.06%"};
		{ 19, 54933, "", "=q4=Robes of Prophecy (Shadow)", "=ds="..BabbleBoss["Golemagg the Incinerator"].."", "", "15.65%"};
		{ 20, 54934, "", "=q4=Vambraces of Prophecy (Shadow)", "=ds="..AL["Trash Mobs"].."", "", "0.16%"};
		{ 21, 54935, "", "=q4=Gloves of Prophecy (Shadow)", "=ds="..BabbleBoss["Gehennas"].."", "", "18.65%"};
		{ 22, 54936, "", "=q4=Girdle of Prophecy (Shadow)", "=ds="..AL["Trash Mobs"].."", "", "0.18%"};
		{ 23, 54937, "", "=q4=Pants of Prophecy (Shadow)", "=ds="..BabbleBoss["Magmadar"].."", "", "14.33%"};
		{ 24, 54938, "", "=q4=Boots of Prophecy (Shadow)", "=ds="..BabbleBoss["Shazzrah"].."", "", "14.90%"};
		Back="T1Priest";
	};
	AtlasLoot_Data["T1ShamanRestoration"]= {
	...
	AtlasLoot_Data["T1ShamanElemental"]= {
		{ 1, 54891, "", "=q4=Earthfury Helmet (Elemental)", "=ds="..BabbleBoss["Garr"].."", "", "3.91%"};
		{ 2, 54892, "", "=q4=Earthfury Epaulets (Elemental)", "=ds="..BabbleBoss["Baron Geddon"].."", "", "7.29%"};
		{ 3, 54893, "", "=q4=Earthfury Vestments (Elemental)", "=ds="..BabbleBoss["Golemagg the Incinerator"].."", "", "6.08%"};
		{ 4, 54894, "", "=q4=Earthfury Bracers (Elemental)", "=ds="..AL["Trash Mobs"].."", "", "0.06%"};
		{ 5, 54895, "", "=q4=Earthfury Gauntlets (Elemental)", "=ds="..BabbleBoss["Gehennas"].."", "", "7.38%"};
		{ 6, 54896, "", "=q4=Earthfury Belt (Elemental)", "=ds="..AL["Trash Mobs"].."", "", "0.07%"};
		{ 7, 54897, "", "=q4=Earthfury Legguards (Elemental)", "=ds="..BabbleBoss["Magmadar"].."", "", "4.73%"};
		{ 8, 54898, "", "=q4=Earthfury Boots (Elemental)", "=ds="..BabbleBoss["Lucifron"].."", "", "4.16%"};
		Back="T1Shaman";
	};
	AtlasLoot_Data["T1ShamanEnhancement"]= {
		{ 1, 0, "Spell_FireResistanceTotem_01", "=q6=#t1s7#", "=ec1=#m30#"};
		{ 2, 54899, "", "=q4=Earthfury Helmet (Enhancement)", "=ds="..BabbleBoss["Garr"].."", "", "3.91%"};
		{ 3, 54900, "", "=q4=Earthfury Epaulets (Enhancement)", "=ds="..BabbleBoss["Baron Geddon"].."", "", "7.29%"};
		{ 4, 54901, "", "=q4=Earthfury Vestments (Enhancement)", "=ds="..BabbleBoss["Golemagg the Incinerator"].."", "", "6.08%"};
		{ 5, 54902, "", "=q4=Earthfury Bracers (Enhancement)", "=ds="..AL["Trash Mobs"].."", "", "0.06%"};
		{ 6, 54903, "", "=q4=Earthfury Gauntlets (Enhancement)", "=ds="..BabbleBoss["Gehennas"].."", "", "7.38%"};
		{ 7, 54904, "", "=q4=Earthfury Belt (Enhancement)", "=ds="..AL["Trash Mobs"].."", "", "0.07%"};
		{ 8, 54905, "", "=q4=Earthfury Legguards (Enhancement)", "=ds="..BabbleBoss["Magmadar"].."", "", "4.73%"};
		{ 9, 54906, "", "=q4=Earthfury Boots (Enhancement)", "=ds="..BabbleBoss["Lucifron"].."", "", "4.16%"};
		Back= "T1Shaman";
	};
	AtlasLoot_Data["T1ShamanTank"] = {
		Back="T1Shaman";
	};
	...
	AtlasLoot_Data["T1Monk"]= {
		{ 1, 0, "Spell_Holy_PowerWordShield", "=q6=Scarlet Regalia", "=ec1=#m30#"};
		{ 2, 57716, "", "=q4=Scarlet Mask", "=ds="..BabbleBoss["Garr"].."", "", "11.36%"};
		{ 3, 57717, "", "=q4=Scarlet Mantle", "=ds="..BabbleBoss["Sulfuron Harbinger"].."", "", "21.06%"};
		{ 4, 57718, "", "=q4=Scarlet Vest", "=ds="..BabbleBoss["Golemagg the Incinerator"].."", "", "15.65%"};
		{ 5, 57719, "", "=q4=Scarlet Vambraces", "=ds="..AL["Trash Mobs"].."", "", "0.16%"};
		{ 6, 57720, "", "=q4=Scarlet Handguards", "=ds="..BabbleBoss["Gehennas"].."", "", "18.65%"};
		{ 7, 57721, "", "=q4=Scarlet Girdle", "=ds="..AL["Trash Mobs"].."", "", "0.18%"};
		{ 8, 57722, "", "=q4=Scarlet Legguards", "=ds="..BabbleBoss["Magmadar"].."", "", "14.33%"};
		{ 9, 57723, "", "=q4=Scarlet Boots", "=ds="..BabbleBoss["Shazzrah"].."", "", "14.90%"};
		Back="T1SET";
	};
	AtlasLoot_Data["T1DruidRestoration"]= {
		{ 1, 54875, "", "=q4=Cenarion Helm (Restoration)", "=ds="..BabbleBoss["Garr"].."", "", "11.51%"};
		{ 2, 54876, "", "=q4=Cenarion Spaulders (Restoration)", "=ds="..BabbleBoss["Baron Geddon"].."", "", "19.52%"};
		{ 3, 54877, "", "=q4=Cenarion Vestments (Restoration)", "=ds="..BabbleBoss["Golemagg the Incinerator"].."", "", "15.21%"};
		{ 4, 54878, "", "=q4=Cenarion Bracers (Restoration)", "=ds="..AL["Trash Mobs"].."", "", "0.17%"};
		{ 5, 54879, "", "=q4=Cenarion Gloves (Restoration)", "=ds="..BabbleBoss["Shazzrah"].."", "", "19.53%"};
		{ 6, 54880, "", "=q4=Cenarion Belt (Restoration)", "=ds="..AL["Trash Mobs"].."", "", "0.16%"};
		{ 7, 54881, "", "=q4=Cenarion Leggings (Restoration)", "=ds="..BabbleBoss["Magmadar"].."", "", "12.90%"};
		{ 8, 54882, "", "=q4=Cenarion Boots (Restoration)", "=ds="..BabbleBoss["Lucifron"].."", "", "10.72%"};
		Back="T1Druid";
	};
	AtlasLoot_Data["T1DruidBalance"]= {
		{ 1, 54867, "", "=q4=Cenarion Helm (Balance)", "=ds="..BabbleBoss["Garr"].."", "", "11.51%"};
		{ 2, 54868, "", "=q4=Cenarion Spaulders (Balance)", "=ds="..BabbleBoss["Baron Geddon"].."", "", "19.52%"};
		{ 3, 54869, "", "=q4=Cenarion Vestments (Balance)", "=ds="..BabbleBoss["Golemagg the Incinerator"].."", "", "15.21%"};
		{ 4, 54870, "", "=q4=Cenarion Bracers (Balance)", "=ds="..AL["Trash Mobs"].."", "", "0.17%"};
		{ 5, 54871, "", "=q4=Cenarion Gloves (Balance)", "=ds="..BabbleBoss["Shazzrah"].."", "", "19.53%"};
		{ 6, 54872, "", "=q4=Cenarion Belt (Balance)", "=ds="..AL["Trash Mobs"].."", "", "0.16%"};
		{ 7, 54873, "", "=q4=Cenarion Leggings (Balance)", "=ds="..BabbleBoss["Magmadar"].."", "", "12.90%"};
		{ 8, 54874, "", "=q4=Cenarion Boots (Balance)", "=ds="..BabbleBoss["Lucifron"].."", "", "10.72%"};
		Back="T1Druid";
	};
	AtlasLoot_Data["T1DruidFeral"]= {
		{ 1, 54858, "", "=q4=Cenarion Helm (Feral)", "=ds="..BabbleBoss["Garr"].."", "", "11.51%"};
		{ 2, 54859, "", "=q4=Cenarion Spaulders (Feral)", "=ds="..BabbleBoss["Baron Geddon"].."", "", "19.52%"};
		{ 3, 54861, "", "=q4=Cenarion Vestments (Feral)", "=ds="..BabbleBoss["Golemagg the Incinerator"].."", "", "15.21%"};
		{ 4, 54862, "", "=q4=Cenarion Bracers (Feral)", "=ds="..AL["Trash Mobs"].."", "", "0.17%"};
		{ 5, 54863, "", "=q4=Cenarion Gloves (Feral)", "=ds="..BabbleBoss["Shazzrah"].."", "", "19.53%"};
		{ 6, 54864, "", "=q4=Cenarion Belt (Feral)", "=ds="..AL["Trash Mobs"].."", "", "0.16%"};
		{ 7, 54865, "", "=q4=Cenarion Leggings (Feral)", "=ds="..BabbleBoss["Magmadar"].."", "", "12.90%"};
		{ 8, 54866, "", "=q4=Cenarion Boots (Feral)", "=ds="..BabbleBoss["Lucifron"].."", "", "10.72%"};
		Back="T1Druid";
	};

	AtlasLoot_Data["T1Bard"] = {
		Back="T1SET"
	};

	AtlasLoot_Data["T1Druid"] = {
		{ 1, "T1DruidFeral", "Spell_Nature_Unyeildingstamina", "=ds=Feral", "=q5=T1" },
		{ 2, "T1DruidRestoration", "Spell_Nature_Rejuvenation", "=ds=Restoration", "=q5=T1" },
		{ 3, "T1DruidBalance", "Spell_Arcane_Arcane03", "=ds=Balance", "=q5=T1" },
		Back = "T1SET",
	};
	
	AtlasLoot_Data["T1Priest"] = {
		{ 1, "T1PriestHeal", "spell_holy_heal", "=ds=Heal", "=q5=T1" },
		{ 2, "T1PriestShadow", "spell_shadow_summonvoidwalker", "=ds=Shadow", "=q5=T1" },
		Back = "T1SET",
	};
	
	AtlasLoot_Data["T1Paladin"] = {
		{ 1, "T1PaladinProtection", "spell_holy_avengersshield", "=ds=Protection", "=q5=T1" },
		{ 2, "T1PaladinHoly", "spell_holy_searinglight", "=ds=Holy", "=q5=T1" },
		{ 3, "T1PaladinRetribution", "ability_paladin_divinestorm", "=ds=Retribution", "=q5=T1" },
		Back = "T1SET",
	};
	
	AtlasLoot_Data["T1Shaman"] = {
		{ 1, "T1ShamanTank", "spell_nature_lightningshield", "=ds=Tank", "=q5=T1" },
		{ 2, "T1ShamanRestoration", "spell_nature_riptide", "=ds=Restoration", "=q5=T1" },
		{ 3, "T1ShamanEnhancement", "ability_shaman_stormstrike", "=ds=Enhancement", "=q5=T1" },
		{ 4, "T1ShamanElemental", "spell_nature_lightning", "=ds=Elemental", "=q5=T1" },
		Back = "T1SET",
	};
	
	AtlasLoot_Data["T1Warrior"] = {
		{ 1, "T1WarriorProtection", "inv_shield_06", "=ds=Protection", "=q5=T1" },
		{ 2, "T1WarriorDamage", "ability_parry", "=ds=Damage", "=q5=T1" },
		Back = "T1SET",
	};
	
	AtlasLoot_Data["T1Dk"] = {
		{ 1, "T1DkTank", "spell_deathknight_butcher2", "=ds=Tank", "=q5=T1" },
		{ 2, "T1DkDamage", "spell_shadow_plaguecloud", "=ds=Damage", "=q5=T1" },
		Back = "T1SET",
	};
		------------------------
		--- Tier 2 Sets (T2) ---
	...
	AtlasLoot_Data["T2DruidRestoration"] = {
		{ 1, 16900, "", "=q4=Stormrage Cover", "=ds="..BabbleBoss["Onyxia"], "", "13.08%"};
	...
	AtlasLoot_Data["T2DruidBalance"] = {
		{ 1, 56899, "", "=q4=Stormrage Cover (Balance)", "=ds=", "", ""};
		{ 2, 56898, "", "=q4=Stormrage Pauldrons (Balance)", "=ds="..BabbleBoss["Chromaggus"], "", "14.63%"};
		{ 3, 56897, "", "=q4=Stormrage Chestguard (Balance)", "=ds="..BabbleBoss["Nefarian"], "", "11.89%"};
		{ 4, 56896, "", "=q4=Stormrage Bracers (Balance)", "=ds="..BabbleBoss["Razorgore the Untamed"], "", "17.38%"};
		{ 5, 56895, "", "=q4=Stormrage Handguards (Balance)", "=ds="..BabbleBoss["Firemaw"]..", "..BabbleBoss["Ebonroc"]..", "..BabbleBoss["Flamegor"], "", "5.34%"};
		{ 6, 56894, "", "=q4=Stormrage Belt (Balance)", "=ds="..BabbleBoss["Vaelastrasz the Corrupt"], "", "16.90%"};
		{ 7, 56893, "", "=q4=Stormrage Legguards (Balance)", "=ds="..BabbleBoss["Ragnaros"], "", "15.49%"};
		{ 8, 56892, "", "=q4=Stormrage Boots (Balance)", "=ds="..BabbleBoss["Broodlord Lashlayer"], "", "13.79%"};
		Back="T2Druid";
	};
	AtlasLoot_Data["T2DruidFeral"] = {
		{ 1, 56884, "", "=q4=Stormrage Cover (Feral)", "", "", ""};
		{ 2, 56885, "", "=q4=Stormrage Pauldrons (Feral)", "=ds="..BabbleBoss["Chromaggus"], "", "14.63%"};
		{ 3, 56886, "", "=q4=Stormrage Chestguard (Feral)", "=ds="..BabbleBoss["Nefarian"], "", "11.89%"};
		{ 4, 56887, "", "=q4=Stormrage Bracers (Feral)", "=ds="..BabbleBoss["Razorgore the Untamed"], "", "17.38%"};
		{ 5, 56888, "", "=q4=Stormrage Handguards (Feral)", "=ds="..BabbleBoss["Firemaw"]..", "..BabbleBoss["Ebonroc"]..", "..BabbleBoss["Flamegor"], "", "5.34%"};
		{ 6, 56889, "", "=q4=Stormrage Belt (Feral)", "=ds="..BabbleBoss["Vaelastrasz the Corrupt"], "", "16.90%"};
		{ 7, 56890, "", "=q4=Stormrage Legguards (Feral)", "=ds="..BabbleBoss["Ragnaros"], "", "15.49%"};
		{ 8, 56891, "", "=q4=Stormrage Boots (Feral)", "=ds="..BabbleBoss["Broodlord Lashlayer"], "", "13.79%"};
		Back="T2Druid";
	};
	AtlasLoot_Data["T2Hunter"] = {
		{ 1, 16939, "", "=q4=Dragonstalker's Helm", "=ds="..BabbleBoss["Onyxia"], "", "13.91%"};
	...
	AtlasLoot_Data["T2Mage"] = {
		{ 1, 16914, "", "=q4=Netherwind Crown", "=ds="..BabbleBoss["Onyxia"], "", "14.09%"};
	...
	AtlasLoot_Data["T2PaladinHoly"] = {
		{ 1, 16955, "", "=q4=Judgement Crown", "=ds="..BabbleBoss["Onyxia"], "", "8.64%"};
	...
	AtlasLoot_Data["T2PaladinProtection"] = {
		{ 1, 56924, "", "=q4=Judgement Crown (Protection)", "=ds=", "", ""};
		{ 2, 56925, "", "=q4=Judgement Spaulders (Protection)", "=ds="..BabbleBoss["Chromaggus"], "", "10.97%"};
		{ 3, 56926, "", "=q4=Judgement Breastplate (Protection)", "=ds="..BabbleBoss["Nefarian"], "", "9.24%"};
		{ 4, 56927, "", "=q4=Judgement Bindings (Protection)", "=ds="..BabbleBoss["Razorgore the Untamed"], "", "13.61%"};
		{ 5, 56928, "", "=q4=Judgement Gauntlets (Protection)", "=ds="..BabbleBoss["Firemaw"]..", "..BabbleBoss["Ebonroc"]..", "..BabbleBoss["Flamegor"], "", "3.58%"};
		{ 6, 56929, "", "=q4=Judgement Belt (Protection)", "=ds="..BabbleBoss["Vaelastrasz the Corrupt"], "", "12.23%"};
		{ 7, 56930, "", "=q4=Judgement Legplates (Protection)", "=ds="..BabbleBoss["Ragnaros"], "", "15.49%"};
		{ 8, 56931, "", "=q4=Judgement Sabatons (Protection)", "=ds="..BabbleBoss["Broodlord Lashlayer"], "", "11.28%"};
		Back="T2Paladin";
	};
	AtlasLoot_Data["T2PaladinRetribution"] = {
		{ 1, 56916, "", "=q4=Judgement Crown (Retribution)", "=ds=", "", ""};
		{ 2, 56917, "", "=q4=Judgement Spaulders (Retribution)", "=ds="..BabbleBoss["Chromaggus"], "", "10.97%"};
		{ 3, 56918, "", "=q4=Judgement Breastplate (Retribution)", "=ds="..BabbleBoss["Nefarian"], "", "9.24%"};
		{ 4, 56919, "", "=q4=Judgement Bindings (Retribution)", "=ds="..BabbleBoss["Razorgore the Untamed"], "", "13.61%"};
		{ 5, 56920, "", "=q4=Judgement Gauntlets (Retribution)", "=ds="..BabbleBoss["Firemaw"]..", "..BabbleBoss["Ebonroc"]..", "..BabbleBoss["Flamegor"], "", "3.58%"};
		{ 6, 56921, "", "=q4=Judgement Belt (Retribution)", "=ds="..BabbleBoss["Vaelastrasz the Corrupt"], "", "12.23%"};
		{ 7, 56922, "", "=q4=Judgement Legplates (Retribution)", "=ds="..BabbleBoss["Ragnaros"], "", "15.49%"};
		{ 8, 56923, "", "=q4=Judgement Sabatons (Retribution)", "=ds="..BabbleBoss["Broodlord Lashlayer"], "", "11.28%"};
		Back="T2Paladin";
	};
	AtlasLoot_Data["T2PriestShadow"] = {
		{ 1, 56908, "", "=q4=Halo of Transcendence (DPS)", "=ds=", "", ""};
		{ 2, 56909, "", "=q4=Pauldrons of Transcendence (DPS)", "=ds="..BabbleBoss["Chromaggus"], "", "17.83%"};
		{ 3, 56910, "", "=q4=Robes of Transcendence (DPS)", "=ds="..BabbleBoss["Nefarian"], "", "14.83%"};
		{ 4, 56911, "", "=q4=Bindings of Transcendence (DPS)", "=ds="..BabbleBoss["Razorgore the Untamed"], "", "20.37%"};
		{ 5, 56912, "", "=q4=Handguards of Transcendence (DPS)", "=ds="..BabbleBoss["Firemaw"]..", "..BabbleBoss["Ebonroc"]..", "..BabbleBoss["Flamegor"], "", "6.01%"};
		{ 6, 56913, "", "=q4=Belt of Transcendence (DPS)", "=ds="..BabbleBoss["Vaelastrasz the Corrupt"], "", "18.76%"};
		{ 7, 56914, "", "=q4=Leggings of Transcendence (DPS)", "=ds="..BabbleBoss["Ragnaros"], "", "15.49%"};
		{ 8, 56915, "", "=q4=Boots of Transcendence (DPS)", "=ds="..BabbleBoss["Broodlord Lashlayer"], "", "14.61%"};
		Back="T2SET";
	};
	AtlasLoot_Data["T2PriestHeal"]={
		{ 1, 16921, "", "=q4=Halo of Transcendence", "=ds="..BabbleBoss["Onyxia"], "", "13.39%"};
	...
	AtlasLoot_Data["T2Rogue"] = {
		{ 1, 16908, "", "=q4=Bloodfang Hood", "=ds="..BabbleBoss["Onyxia"], "", "13.21%"};
	...
	AtlasLoot_Data["T2ShamanElemental"] = {
		{ 1, 56947, "", "=q4=Helmet of Ten Storms (Elemental)", "=ds=", "", ""};
		{ 2, 56946, "", "=q4=Epaulets of Ten Storms (Elemental)", "=ds="..BabbleBoss["Chromaggus"], "", "6.73%"};
		{ 3, 56945, "", "=q4=Breastplate of Ten Storms (Elemental)", "=ds="..BabbleBoss["Nefarian"], "", "5.65%"};
		{ 4, 56944, "", "=q4=Bracers of Ten Storms (Elemental)", "=ds="..BabbleBoss["Razorgore the Untamed"], "", "7.54%"};
		{ 5, 56943, "", "=q4=Gauntlets of Ten Storms (Elemental)", "=ds="..BabbleBoss["Firemaw"]..", "..BabbleBoss["Ebonroc"]..", "..BabbleBoss["Flamegor"], "", "2.13%"};
		{ 6, 56942, "", "=q4=Belt of Ten Storms (Elemental)", "=ds="..BabbleBoss["Vaelastrasz the Corrupt"], "", "6.93%"};
		{ 7, 56941, "", "=q4=Legplates of Ten Storms (Elemental)", "=ds="..BabbleBoss["Ragnaros"], "", "15.49%"};
		{ 8, 56940, "", "=q4=Greaves of Ten Storms (Elemental)", "=ds="..BabbleBoss["Broodlord Lashlayer"], "", "5.57%"};
		Back="T2Shaman";
	};
	AtlasLoot_Data["T2ShamanRestoration"]={
		{ 1, 16947, "", "=q4=Helmet of Ten Storms", "=ds="..BabbleBoss["Onyxia"], "", "4.86%"};
	...
	AtlasLoot_Data["T2ShamanEnhancement"] = {
		{ 1, 56932, "", "=q4=Helmet of Ten Storms (Enhancement)", "=ds=", "", ""};
		{ 2, 56933, "", "=q4=Epaulets of Ten Storms (Enhancement)", "=ds="..BabbleBoss["Chromaggus"], "", "6.73%"};
		{ 3, 56934, "", "=q4=Breastplate of Ten Storms (Enhancement)", "=ds="..BabbleBoss["Nefarian"], "", "5.65%"};
		{ 4, 56935, "", "=q4=Bracers of Ten Storms (Enhancement)", "=ds="..BabbleBoss["Razorgore the Untamed"], "", "7.54%"};
		{ 5, 56936, "", "=q4=Gauntlets of Ten Storms (Enhancement)", "=ds="..BabbleBoss["Firemaw"]..", "..BabbleBoss["Ebonroc"]..", "..BabbleBoss["Flamegor"], "", "2.13%"};
		{ 6, 56937, "", "=q4=Belt of Ten Storms (Enhancement)", "=ds="..BabbleBoss["Vaelastrasz the Corrupt"], "", "6.93%"};
		{ 7, 56938, "", "=q4=Legplates of Ten Storms (Enhancement)", "=ds="..BabbleBoss["Ragnaros"], "", "15.49%"};
		{ 8, 56939, "", "=q4=Greaves of Ten Storms (Enhancement)", "=ds="..BabbleBoss["Broodlord Lashlayer"], "", "5.57%"};
		Back="T2Shaman";
	};
	AtlasLoot_Data["T2ShamanTank"] = {
		{ 1, 56932, "", "=q4=Helmet of Ten Storms (Enhancement)", "=ds=", "", ""};
		{ 2, 56933, "", "=q4=Epaulets of Ten Storms (Enhancement)", "=ds="..BabbleBoss["Chromaggus"], "", "6.73%"};
		{ 3, 56934, "", "=q4=Breastplate of Ten Storms (Enhancement)", "=ds="..BabbleBoss["Nefarian"], "", "5.65%"};
		{ 4, 56935, "", "=q4=Bracers of Ten Storms (Enhancement)", "=ds="..BabbleBoss["Razorgore the Untamed"], "", "7.54%"};
	...
	AtlasLoot_Data["T2Warlock"] = {
		{ 1, 16929, "", "=q4=Nemesis Skullcap", "=ds="..BabbleBoss["Onyxia"], "", "13.54%"};
	...
	AtlasLoot_Data["T2WarriorProtection"] = {
		{ 1, 16963, "", "=q4=Helm of Wrath", "=ds="..BabbleBoss["Onyxia"], "", "13.65%"};
	...
	AtlasLoot_Data["T2WarriorDamage"]={
		{ 1, 56900, "", "=q4=Helm of Wrath (DPS)", "=ds=", "", ""};
		{ 2, 56901, "", "=q4=Pauldrons of Wrath (DPS)", "=ds="..BabbleBoss["Chromaggus"], "", "16.83%"};
		{ 3, 56902, "", "=q4=Breastplate of Wrath (DPS)", "=ds="..BabbleBoss["Nefarian"], "", "15.06%"};
		{ 4, 56903, "", "=q4=Bracelets of Wrath (DPS)", "=ds="..BabbleBoss["Razorgore the Untamed"], "", "20.29%"};
		{ 5, 56904, "", "=q4=Gauntlets of Wrath (DPS)", "=ds="..BabbleBoss["Firemaw"]..", "..BabbleBoss["Ebonroc"]..", "..BabbleBoss["Flamegor"], "", "5.93%"};
		{ 6, 56905, "", "=q4=Waistband of Wrath (DPS)", "=ds="..BabbleBoss["Vaelastrasz the Corrupt"], "", "20.03%"};
		{ 7, 56906, "", "=q4=Legplates of Wrath (DPS)", "=ds="..BabbleBoss["Ragnaros"], "", "15.49%"};
		{ 8, 56907, "", "=q4=Sabatons of Wrath (DPS)", "=ds="..BabbleBoss["Broodlord Lashlayer"], "", "16.84%"};
		Back="T2Warrior";
	};
	AtlasLoot_Data["T2Druid"] = {
		{ 1, "T2DruidFeral", "Spell_Nature_Unyeildingstamina", "=ds=Feral", "=q5=T2"};
		{ 2, "T2DruidRestoration", "Spell_Nature_Rejuvenation", "=ds=Restoration", "=q5=T2"};
		{ 3, "T2DruidBalance", "Spell_Arcane_Arcane03", "=ds=Balance", "=q5=T2"};
		Back = "T2SET";
	};
	AtlasLoot_Data["T2Priest"] = {
		{ 1, "T2PriestHeal", "spell_holy_heal", "=ds=Heal", "=q5=T2"};
		{ 2, "T2PriestShadow", "spell_shadow_summonvoidwalker", "=ds=Shadow", "=q5=T2"};
		Back = "T2SET";
	};
	AtlasLoot_Data["T2Paladin"] = {
		{ 1, "T2PaladinProtection","spell_holy_avengersshield","=ds=Protection", "=q5=T2"};
		{ 2, "T2PaladinHoly","spell_holy_searinglight","=ds=Holy", "=q5=T2"};
		{ 3, "T2PaladinRetribution","ability_paladin_divinestorm","=ds=Retribution", "=q5=T2"};
		Back = "T2SET";
	};
	AtlasLoot_Data["T2Shaman"] = {
		{ 1, "T2ShamanTank","spell_nature_lightningshield","=ds=Tank", "=q5=T2"};
		{ 2, "T2ShamanRestoration","spell_nature_riptide","=ds=Restoration", "=q5=T2"};
		{ 3, "T2ShamanEnhancement","ability_shaman_stormstrike","=ds=Enhancement", "=q5=T2"};
		{ 4, "T2ShamanElemental","spell_nature_lightning","=ds=Elemental", "=q5=T2"};
		Back = "T2SET";
	};
	AtlasLoot_Data["T2Warrior"] = {
		{ 1, "T2WarriorProtection","inv_shield_06","=ds=Protection", "=q5=T2"};
		{ 2, "T2WarriorDamage","ability_parry","=ds=Damage", "=q5=T2"};
		Back = "T2SET";
	};
	AtlasLoot_Data["T2Dk"] = {
		{ 1, "T2DkTank","spell_deathknight_butcher2","=ds=Tank", "=q5=T2"};
		{ 2, "T2DkDamage","spell_shadow_plaguecloud","=ds=Damage", "=q5=T2"};
		Back = "T2SET";
	};

	AtlasLoot_Data["T2DkTank"]={
		{ 1, 16963, "", "=q4=Helm of Wrath", "=ds="..BabbleBoss["Onyxia"], "", "13.65%"};
		{ 2, 16961, "", "=q4=Pauldrons of Wrath", "=ds="..BabbleBoss["Chromaggus"], "", "16.83%"};
		{ 3, 16966, "", "=q4=Breastplate of Wrath", "=ds="..BabbleBoss["Nefarian"], "", "15.06%"};
		{ 4, 16959, "", "=q4=Bracelets of Wrath", "=ds="..BabbleBoss["Razorgore the Untamed"], "", "20.29%"};
	...
	AtlasLoot_Data["T3Monk"] = {
		Back = "T3SET"
	};
	AtlasLoot_Data["T3Bard"] = {
		Back = "T3SET"
	};
		------------------------
		--- Vanilla WoW Sets ---
	...
	AtlasLoot_Data["LordKazzak"] = {
		...
		{ 2, 17112, "", "=q4=Empyrean Demolisher", "=ds=#h1#, #w6#", "", "21.3%"};
		{ 3, 17113, "", "=q4=Amberseal Keeper", "=ds=#w9#", "", "19.8%"};
		{ 4, 18546, "", "=q4=Infernal Headcage", "=ds=#s1#, #a3#", "", "22.9%"};
		{ 5, 19133, "", "=q4=Fel Infused Lggings", "=ds=#s11#, #a1#", "", "12%"};
		{ 6, 18544, "", "=q4=Doomhide Gaunlets", "=ds=#s9#, #a2#", "", "6%"};
		{ 7, 18204, "", "=q4=Eskhander's Pelt", "=ds=#s4#", "", "12.93%"};
		{ 8, 19135, "", "=q4=Blacklight Bracer", "=ds=#s8#, #a1#", "", "3.6%"};
		{ 9, 19134, "", "=q4=Flayed Doomguard Belt", "=ds=#s10#, #a2#", "", "3.6%"};
		{ 10, 17111, "", "=q4=Blazefury Medallion", "=ds=#s2#", "", "2.4%"};
		{ 11, 18543, "", "=q4=Ring of Entropy", "=ds=#s13#", "", "7.2%"};
		{ 16, 18665, "", "=q4=The Eye of Shadow", "=ds=#m3# =q1=(#c5#)", "", "41%"};
		{ 17, 18608, "", "=q4=Benediction", "=q1=#m4#: =ds=#w9#"};
	};